...
Confluence.Templates.User.logo = function(opt_data, opt_ignored) {
  return '' + ((opt_data.profilePictureInfo['default'] && opt_data.username == opt_data.currentUsername) ? '<a ' + ((opt_data.canView) ? ' ' + ((! opt_data.disableUserHover) ? 'class="userLogoLink"' : '') + ' data-username="' + soy.$$escapeHtml(opt_data.username) + '"' : '') + ' href="' + soy.$$escapeHtml("/confluence") + '/users/profile/editmyprofilepicture.action" title="' + soy.$$escapeHtml("Add a picture of yourself") + '"><img class="userLogo logo defaultLogo" src="' + soy.$$escapeHtml("/confluence/s/en_GB/6441/ceb41ce4dba5df18f2191c32f0465b43365a715a/_") + '/images/icons/profilepics/add_profile_pic.png" alt="' + soy.$$escapeHtml("User icon") + ': ' + soy.$$escapeHtml("Add a picture of yourself") + '"></a>' : (opt_data.profilePictureInfo.anonymous) ? '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/confluence/s/en_GB/6441/ceb41ce4dba5df18f2191c32f0465b43365a715a/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml("User icon") + ': ' + soy.$$escapeHtml("Anonymous") + '" title="' + soy.$$escapeHtml("Anonymous") + '">' : (opt_data.canView) ? '<a ' + ((! opt_data.disableUserHover) ? 'class="userLogoLink"' : '') + ' data-username="' + soy.$$escapeHtml(opt_data.username) + '" href="' + Confluence.Templates.User.userLinkUrl(opt_data) + '"><img class="userLogo logo" src="' + soy.$$escapeHtml(opt_data.profilePictureInfo.uriReference) + '" alt="' + soy.$$escapeHtml("User icon") + ': ' + soy.$$escapeHtml(opt_data.username) + '" title="' + soy.$$escapeHtml(opt_data.username) + '"></a>' : '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/confluence/s/en_GB/6441/ceb41ce4dba5df18f2191c32f0465b43365a715a/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml("User icon") + ': ' + soy.$$escapeHtml(opt_data.username) + '" title="' + soy.$$escapeHtml(opt_data.username) + '">');
};
if (goog.DEBUG) {
...
;
try {
/* module-key = 'net.customware.confluence.plugin.composition:tutorial-progress-menu', location = 'js/tutorial-progress-menu.js' */
!function(a){function c(f){if(b[f]){return b[f].exports}var d=b[f]={exports:{},id:f,loaded:!1};return a[f].call(d.exports,d,d.exports,c),d.loaded=!0,d.exports}var b={};return c.m=a,c.c=b,c.p="",c(0)}({0:function(b,g,c){function d(e){return e&&e.__esModule?e:{"default":e}}var a=c(328),f=d(a);AJS.toInit(function(){new f["default"]({ids:{compositionTutorialStepsButton:"#composition-tutorial-steps-link",buttonSpinner:".button-spinner",withdrawButtonSelector:"#withdraw-button"}})})},10:function(f,k,g){var h=g(96)("wks"),d=g(99),j=g(11).Symbol,c="function"==typeof j,b=f.exports=function(a){return h[a]||(h[a]=c&&j[a]||(c?j:d)("Symbol."+a))};b.store=h},11:function(a,c){var b=a.exports="undefined"!=typeof window&&window.Math==Math?window:"undefined"!=typeof self&&self.Math==Math?self:Function("return this")();"number"==typeof __g&&(__g=b)},17:function(a,c){var b=a.exports={version:"2.4.0"};"number"==typeof __e&&(__e=b)},19:function(a,d,b){var c=b(47);a.exports=function(e){if(!c(e)){throw TypeError(e+" is not an object!")}return e}},22:function(a,c,b){a.exports=!b(91)(function(){return 7!=Object.defineProperty({},"a",{get:function(){return 7}}).a})},23:function(b,f,c){var d=c(33),a=c(95);b.exports=c(22)?function(e,h,g){return d.f(e,h,a(1,g))}:function(e,h,g){return e[h]=g,e}},32:function(a,b){a.exports={}},33:function(c,h,d){var f=d(19),b=d(148),g=d(169),a=Object.defineProperty;h.f=d(22)?Object.defineProperty:function(i,k,j){if(f(i),k=g(k,!0),f(j),b){try{return a(i,k,j)}catch(e){}}if("get" in j||"set" in j){throw TypeError("Accessors not supported!")}return"value" in j&&(i[k]=j.value),i}},44:function(a,c){var b={}.toString;a.exports=function(d){return b.call(d).slice(8,-1)}},45:function(a,d,b){var c=b(59);a.exports=function(e,g,f){if(c(e),void 0===g){return e}switch(f){case 1:return function(h){return e.call(g,h)};case 2:return function(h,i){return e.call(g,h,i)};case 3:return function(j,k,h){return e.call(g,j,k,h)}}return function(){return e.apply(g,arguments)}}},46:function(a,c){var b={}.hasOwnProperty;a.exports=function(d,e){return b.call(d,e)}},47:function(a,b){a.exports=function(c){return"object"==typeof c?null!==c:"function"==typeof c}},59:function(a,b){a.exports=function(c){if("function"!=typeof c){throw TypeError(c+" is not a function!")}return c}},60:function(a,b){a.exports=function(c){if(void 0==c){throw TypeError("Can't call method on  "+c)}return c}},61:function(b,g,c){var d=c(47),a=c(11).document,f=d(a)&&d(a.createElement);b.exports=function(e){return f?a.createElement(e):{}}},62:function(m,f,b){var h=b(11),g=b(17),d=b(45),l=b(23),k="prototype",j=function(E,e,a){var x,o,F,c=E&j.F,q=E&j.G,D=E&j.S,z=E&j.P,C=E&j.B,u=E&j.W,A=q?g:g[e]||(g[e]={}),B=A[k],i=q?h:D?h[e]:(h[e]||{})[k];q&&(a=e);for(x in a){o=!c&&i&&void 0!==i[x],o&&x in A||(F=o?i[x]:a[x],A[x]=q&&"function"!=typeof i[x]?a[x]:C&&o?d(F,h):u&&i[x]==F?function(p){var r=function(v,s,t){if(this instanceof p){switch(arguments.length){case 0:return new p;case 1:return new p(v);case 2:return new p(v,s)}return new p(v,s,t)}return p.apply(this,arguments)};return r[k]=p[k],r}(F):z&&"function"==typeof F?d(Function.call,F):F,z&&((A.virtual||(A.virtual={}))[x]=F,E&j.R&&B&&!B[x]&&l(B,x,F)))}};j.F=1,j.G=2,j.S=4,j.P=8,j.B=16,j.W=32,j.U=64,j.R=128,m.exports=j},63:function(b,g,c){var d=c(33).f,a=c(46),f=c(10)("toStringTag");b.exports=function(e,i,h){e&&!a(e=h?e:e.prototype,f)&&d(e,f,{configurable:!0,value:i})}},64:function(b,f,c){var d=c(96)("keys"),a=c(99);b.exports=function(e){return d[e]||(d[e]=a(e))}},65:function(a,d){var b=Math.ceil,c=Math.floor;a.exports=function(e){return isNaN(e=+e)?0:(e>0?c:b)(e)}},66:function(b,f,c){var d=c(150),a=c(60);b.exports=function(e){return d(a(e))}},86:function(a,c,b){a.exports={"default":b(143),__esModule:!0}},87:function(a,b){b.__esModule=!0,b["default"]=function(c,d){if(!(c instanceof d)){throw new TypeError("Cannot call a class as a function")}}},88:function(b,g,c){function d(e){return e&&e.__esModule?e:{"default":e}}g.__esModule=!0;var a=c(140),f=d(a);g["default"]=function(){function e(h,k){for(var i=0;i<k.length;i++){var j=k[i];j.enumerable=j.enumerable||!1,j.configurable=!0,"value" in j&&(j.writable=!0),(0,f["default"])(h,j.key,j)}}return function(j,h,i){return h&&e(j.prototype,h),i&&e(j,i),j}}()},89:function(c,h,d){var f=d(44),b=d(10)("toStringTag"),g="Arguments"==f(function(){return arguments}()),a=function(e,j){try{return e[j]}catch(i){}};c.exports=function(i){var k,j,e;return void 0===i?"Undefined":null===i?"Null":"string"==typeof(j=a(k=Object(i),b))?j:g?f(k):"Object"==(e=f(k))&&"function"==typeof k.callee?"Arguments":e}},90:function(a,b){a.exports="constructor,hasOwnProperty,isPrototypeOf,propertyIsEnumerable,toLocaleString,toString,valueOf".split(",")},91:function(a,b){a.exports=function(c){try{return !!c()}catch(d){return !0}}},92:function(a,c,b){a.exports=b(11).document&&document.documentElement},93:function(k,y,q){var E=q(94),A=q(62),x=q(163),j=q(23),H=q(46),G=q(32),D=q(153),z=q(63),m=q(159),w=q(10)("iterator"),B=!([].keys&&"next" in [].keys()),b="@@iterator",F="keys",I="values",C=function(){return this};k.exports=function(p,J,u,g,l,K,i){D(u,J,g);var P,N,v,L=function(n){if(!B&&n in h){return h[n]}switch(n){case F:return function(){return new u(this,n)};case I:return function(){return new u(this,n)}}return function(){return new u(this,n)}},c=J+" Iterator",e=l==I,a=!1,h=p.prototype,d=h[w]||h[b]||l&&h[l],o=d||L(l),s=l?e?L("entries"):o:void 0,f="Array"==J?h.entries||d:d;if(f&&(v=m(f.call(new p)),v!==Object.prototype&&(z(v,c,!0),E||H(v,w)||j(v,w,C))),e&&d&&d.name!==I&&(a=!0,o=function(){return d.call(this)}),E&&!i||!B&&!a&&h[w]||j(h,w,o),G[J]=o,G[c]=C,l){if(P={values:e?o:L(I),keys:K?o:L(F),entries:s},i){for(N in P){N in h||x(h,N,P[N])}}else{A(A.P+A.F*(B||a),J,P)}}return P}},94:function(a,b){a.exports=!0},95:function(a,b){a.exports=function(c,d){return{enumerable:!(1&c),configurable:!(2&c),writable:!(4&c),value:d}}},96:function(b,g,c){var d=c(11),a="__core-js_shared__",f=d[a]||(d[a]={});b.exports=function(e){return f[e]||(f[e]={})}},97:function(q,C,z){var I,E,B,m=z(45),L=z(149),K=z(92),H=z(61),D=z(11),x=D.process,A=D.setImmediate,F=D.clearImmediate,k=D.MessageChannel,J=0,M={},G="onreadystatechange",b=function(){var a=+this;if(M.hasOwnProperty(a)){var c=M[a];delete M[a],c()}},j=function(a){b.call(a.data)};A&&F||(A=function(a){for(var d=[],c=1;arguments.length>c;){d.push(arguments[c++])}return M[++J]=function(){L("function"==typeof a?a:Function(a),d)},I(J),J},F=function(a){delete M[a]},"process"==z(44)(x)?I=function(a){x.nextTick(m(b,a,1))}:k?(E=new k,B=E.port2,E.port1.onmessage=j,I=m(B.postMessage,B,1)):D.addEventListener&&"function"==typeof postMessage&&!D.importScripts?(I=function(a){D.postMessage(a+"","*")},D.addEventListener("message",j,!1)):I=G in H("script")?function(a){K.appendChild(H("script"))[G]=function(){K.removeChild(this),b.call(a)}}:function(a){setTimeout(m(b,a,1),0)}),q.exports={set:A,clear:F}},98:function(b,f,c){var d=c(65),a=Math.min;b.exports=function(e){return e>0?a(d(e),9007199254740991):0}},99:function(a,d){var b=0,c=Math.random();a.exports=function(e){return"Symbol(".concat(void 0===e?"":e,")_",(++b+c).toString(36))}},103:function(a,b){a.exports=function(){var c=[];return c.toString=function(){for(var d=[],f=0;f<this.length;f++){var e=this[f];e[2]?d.push("@media "+e[2]+"{"+e[1]+"}"):d.push(e[1])}return d.join("")},c.i=function(k,g){"string"==typeof k&&(k=[[null,k,""]]);for(var h={},f=0;f<this.length;f++){var j=this[f][0];"number"==typeof j&&(h[j]=!0)}for(f=0;f<k.length;f++){var d=k[f];"number"==typeof d[0]&&h[d[0]]||(g&&!d[2]?d[2]=g:g&&(d[2]="("+d[2]+") and ("+g+")"),c.push(d))}},c}},105:function(a,d,b){var c;(function(f,e){(function(){function aF(k,q){if(k!==q){var l=null===k,m=k===bd,j=k===k,p=null===q,h=q===bd,g=q===q;if(k>q&&!p||!j||l&&!h&&g||m&&g){return 1}if(k<q&&!l||!g||p&&!m&&j||h&&j){return -1}}return 0}function ay(h,l,j){for(var k=h.length,g=j?k:-1;j?g--:++g<k;){if(l(h[g],g,h)){return g}}return -1}function aS(h,l,j){if(l!==l){return aq(h,j)}for(var k=j-1,g=h.length;++k<g;){if(h[k]===l){return k}}return -1}function aP(g){return"function"==typeof g||!1}function aN(g){return null==g?"":g+""}function aI(g,k){for(var h=-1,j=g.length;++h<j&&k.indexOf(g.charAt(h))>-1;){}return h}function az(g,j){for(var h=g.length;h--&&j.indexOf(g.charAt(h))>-1;){}return h}function aE(g,h){return aF(g.criteria,h.criteria)||g.index-h.index}function aL(v,h,g){for(var o=-1,k=v.criteria,s=h.criteria,q=k.length,p=g.length;++o<q;){var m=aF(k[o],s[o]);if(m){if(o>=p){return m}var j=g[o];return m*("asc"===j||j===!0?1:-1)}}return v.index-h.index}function ax(g){return ai[g]}function aO(g){return bK[g]}function aT(g,j,h){return j?g=bQ[g]:h&&(g=ad[g]),"\\"+g}function aM(g){return"\\"+ad[g]}function aq(h,m,j){for(var k=h.length,g=m+(j?0:-1);j?g--:++g<k;){var l=h[g];if(l!==l){return g}}return -1}function au(g){return !!g&&"object"==typeof g}function aG(g){return g<=160&&g>=9&&g<=13||32==g||160==g||5760==g||6158==g||g>=8192&&(g<=8202||8232==g||8233==g||8239==g||8287==g||12288==g||65279==g)}function ar(h,m){for(var j=-1,k=h.length,g=-1,l=[];++j<k;){h[j]===m&&(h[j]=bk,l[++g]=j)}return l}function aR(s,j){for(var g,l=-1,k=s.length,h=-1,q=[];++l<k;){var p=s[l],m=j?j(p,l,s):p;l&&g===m||(g=m,q[++h]=p)}return q}function aK(g){for(var j=-1,h=g.length;++j<h&&aG(g.charCodeAt(j));){}return j}function bw(g){for(var h=g.length;h--&&aG(g.charCodeAt(h));){}return h}function aJ(g){return aH[g]}function a7(g2){function g8(m){if(au(m)&&!hI(m)&&!(m instanceof hd)){if(m instanceof hj){return m}if(d5.call(m,"__chain__")&&d5.call(m,"__wrapped__")){return fU(m)}}return new hj(m)}function g4(){}function hj(m,ca,Q){this.__wrapped__=m,this.__actions__=Q||[],this.__chain__=!!ca}function hd(m){this.__wrapped__=m,this.__actions__=[],this.__dir__=1,this.__filtered__=!1,this.__iteratees__=[],this.__takeCount__=ez,this.__views__=[]}function g9(){var m=new hd(this.__wrapped__);return m.__actions__=ck(this.__actions__),m.__dir__=this.__dir__,m.__filtered__=this.__filtered__,m.__iteratees__=ck(this.__iteratees__),m.__takeCount__=this.__takeCount__,m.__views__=ck(this.__views__),m}function ht(){if(this.__filtered__){var m=new hd(this);m.__dir__=-1,m.__filtered__=!0}else{m=this.clone(),m.__dir__*=-1}return m}function gz(){var cn=this.__wrapped__.value(),de=this.__dir__,cr=hI(cn),ee=de<0,dr=cr?cn.length:0,da=gS(0,dr,this.__views__),ci=da.start,er=da.end,eo=er-ci,ec=ee?er:ci-1,dn=this.__iteratees__,co=dn.length,cu=0,du=fc(eo,this.__takeCount__);if(!cr||dr<bl||dr==eo&&du==eo){return gA(ee&&cr?cn.reverse():cn,this.__actions__)}var ce=[];cn:for(;eo--&&cu<du;){ec+=de;for(var ei=-1,et=cn[ec];++ei<co;){var ea=dn[ei],Q=ea.iteratee,ca=ea.type,di=Q(et);if(ca==ap){et=di}else{if(!di){if(ca==br){continue cn}break cn}}}ce[cu++]=et}return ce}function dN(){this.__data__={}}function gR(m){return this.has(m)&&delete this.__data__[m]}function ib(m){return"__proto__"==m?bd:this.__data__[m]}function dR(m){return"__proto__"!=m&&d5.call(this.__data__,m)}function hS(m,Q){return"__proto__"!=m&&(this.__data__[m]=Q),this}function c1(m){var Q=m?m.length:0;for(this.data={hash:fZ(null),set:new cy};Q--;){this.push(m[Q])}}function dk(m,ce){var Q=m.data,ca="string"==typeof ce||fI(ce)?Q.set.has(ce):Q.hash[ce];return ca?0:-1}function cF(m){var Q=this.data;"string"==typeof m||fI(m)?Q.set.add(m):Q.hash[m]=!0}function fj(ca,co){for(var ce=-1,ci=ca.length,Q=-1,cn=co.length,m=f6(ci+cn);++ce<ci;){m[ce]=ca[ce]}for(;++Q<cn;){m[ce++]=co[Q]}return m}function ck(m,ce){var Q=-1,ca=m.length;for(ce||(ce=f6(ca));++Q<ca;){ce[Q]=m[Q]}return ce}function d9(m,ce){for(var Q=-1,ca=m.length;++Q<ca&&ce(m[Q],Q,m)!==!1;){}return m}function cZ(m,ca){for(var Q=m.length;Q--&&ca(m[Q],Q,m)!==!1;){}return m}function b3(m,ce){for(var Q=-1,ca=m.length;++Q<ca;){if(!ce(m[Q],Q,m)){return !1}}return !0}function hP(da,ca,m,cn){for(var ce=-1,Q=da.length,cu=cn,cr=cu;++ce<Q;){var co=da[ce],ci=+ca(co);m(ci,cu)&&(cu=ci,cr=co)}return cr}function g6(ca,co){for(var ce=-1,ci=ca.length,Q=-1,cn=[];++ce<ci;){var m=ca[ce];co(m,ce,ca)&&(cn[++Q]=m)}return cn}function gj(Q,ci){for(var ca=-1,ce=Q.length,m=f6(ce);++ca<ce;){m[ca]=ci(Q[ca],ca,Q)}return m}function eM(Q,ci){for(var ca=-1,ce=ci.length,m=Q.length;++ca<ce;){Q[m+ca]=ci[ca]}return Q}function cD(Q,cn,ca,ce){var m=-1,ci=Q.length;for(ce&&ci&&(ca=Q[++m]);++m<ci;){ca=cn(ca,Q[m],m,Q)}return ca}function dB(Q,ci,ca,ce){var m=Q.length;for(ce&&m&&(ca=Q[--m]);m--;){ca=ci(ca,Q[m],m,Q)}return ca}function fO(m,ce){for(var Q=-1,ca=m.length;++Q<ca;){if(ce(m[Q],Q,m)){return !0}}return !1}function Y(m,ce){for(var Q=m.length,ca=0;Q--;){ca+=+ce(m[Q])||0}return ca}function gP(m,Q){return m===bd?Q:m}function s(m,ce,Q,ca){return m!==bd&&d5.call(ca,Q)?m:ce}function f2(cu,ca,m){for(var ci=-1,ce=H(ca),Q=ce.length;++ci<Q;){var cr=ce[ci],co=cu[cr],cn=m(co,ca[cr],cr,cu,ca);(cn===cn?cn===co:co!==co)&&(co!==bd||cr in cu)||(cu[cr]=cn)}return cu}function h6(m,Q){return null==Q?m:ey(Q,H(Q),m)}function J(cu,ca){for(var m=-1,ci=null==cu,ce=!ci&&dl(cu),Q=ce?cu.length:0,cr=ca.length,co=f6(cr);++m<cr;){var cn=ca[m];ce?co[m]=cG(cn,Q)?cu[cn]:bd:co[m]=ci?bd:cu[cn]}return co}function ey(Q,cn,ca){ca||(ca={});for(var ce=-1,m=cn.length;++ce<m;){var ci=cn[ce];ca[ci]=Q[ci]}return ca}function k(m,ce,Q){var ca=typeof m;return"function"==ca?ce===bd?m:b0(m,ce,Q):null==m?eC:"object"==ca?A(m):ce===bd?fD(m):f7(m,ce)}function hw(de,ca,m,co,ci,Q,da){var cu;if(m&&(cu=ci?m(de,co,ci):m(de)),cu!==bd){return cu}if(!fI(de)){return de}var cr=hI(de);if(cr){if(cu=id(de),!ca){return ck(de,cu)}}else{var cn=gy.call(de),ce=cn==aW;if(cn!=aY&&cn!=bo&&(!ce||ci)){return t[cn]?hT(de,cn,ca):ci?de:{}}if(cu=dS(ce?{}:de),!ca){return h6(cu,de)}}Q||(Q=[]),da||(da=[]);for(var di=Q.length;di--;){if(Q[di]==de){return da[di]}}return Q.push(de),da.push(cu),(cr?d9:cb)(de,function(dr,dn){cu[dn]=hw(dr,ca,m,dn,de,Q,da)}),cu}function fg(m,ca,Q){if("function"!=typeof m){throw new c4(aD)}return dy(function(){m.apply(bd,Q)},ca)}function cQ(da,ca){var m=da?da.length:0,co=[];if(!m){return co}var ci=-1,Q=bT(),cu=Q==aS,cr=cu&&ca.length>=bl?gO(ca):null,cn=ca.length;cr&&(Q=dk,cu=!1,ca=cr);da:for(;++ci<m;){var ce=da[ci];if(cu&&ce===ce){for(var de=cn;de--;){if(ca[de]===ce){continue da}}co.push(ce)}else{Q(ca,ce,0)<0&&co.push(ce)}}return co}function e0(m,ca){var Q=!0;return dZ(m,function(ci,cn,ce){return Q=!!ca(ci,cn,ce)}),Q}function eR(Q,cn,ca,ce){var m=ce,ci=m;return dZ(Q,function(cu,cr,co){var da=+cn(cu,cr,co);(ca(da,m)||da===ce&&da===ci)&&(m=da,ci=cu)}),ci}function fT(Q,ci,ca,ce){var m=Q.length;for(ca=null==ca?0:+ca||0,ca<0&&(ca=-ca>m?0:m+ca),ce=ce===bd||ce>m?m:+ce||0,ce<0&&(ce+=m),m=ca>ce?0:ce>>>0,ca>>>=0;ca<m;){Q[ca++]=ci}return Q}function eD(m,ca){var Q=[];return dZ(m,function(ci,cn,ce){ca(ci,cn,ce)&&Q.push(ci)}),Q}function hB(Q,ci,ca,ce){var m;return ca(Q,function(cn,co,cr){if(ci(cn,co,cr)){return m=ce?co:cn,!1}}),m}function e5(ca,co,ce,ci){ci||(ci=[]);for(var Q=-1,cn=ca.length;++Q<cn;){var m=ca[Q];au(m)&&dl(m)&&(ce||hI(m)||e3(m))?co?e5(m,co,ce,ci):eM(ci,m):ce||(ci[ci.length]=m)}return ci}function R(m,Q){return gC(m,Q,cj)}function cb(m,Q){return gC(m,Q,H)}function gq(m,Q){return dC(m,Q,H)}function fE(ca,co){for(var ce=-1,ci=co.length,Q=-1,cn=[];++ce<ci;){var m=co[ce];gv(ca[m])&&(cn[++Q]=m)}return cn}function ek(Q,ci,ca){if(null!=Q){ca!==bd&&ca in cL(Q)&&(ci=[ca]);for(var ce=0,m=ci.length;null!=Q&&ce<m;){Q=Q[ci[ce++]]}return ce&&ce==m?Q:bd}}function d4(Q,cn,ca,ce,m,ci){return Q===cn||(null==Q||null==cn||!fI(Q)&&!au(cn)?Q!==Q&&cn!==cn:cw(Q,cn,d4,ca,ce,m,ci))}function cw(ca,cr,ci,dr,da,co,Q){var ec=hI(ca),ea=hI(cr),dn=a3,cu=a3;ec||(dn=gy.call(ca),dn==bo?dn=aY:dn!=aY&&(ec=bX(ca))),ea||(cu=gy.call(cr),cu==bo?cu=aY:cu!=aY&&(ea=bX(cr)));var ce=dn==aY,cn=cu==aY,de=dn==cu;if(de&&!ec&&!ce){return dD(ca,cr,dn)}if(!da){var m=ce&&d5.call(ca,"__wrapped__"),du=cn&&d5.call(cr,"__wrapped__");if(m||du){return ci(m?ca.value():ca,du?cr.value():cr,dr,da,co,Q)}}if(!de){return !1}co||(co=[]),Q||(Q=[]);for(var ee=co.length;ee--;){if(co[ee]==ca){return Q[ee]==cr}}co.push(ca),Q.push(cr);var di=(ec?gD:w)(ca,cr,ci,dr,da,co,Q);return co.pop(),Q.pop(),di}function gG(de,ca,m){var co=ca.length,ci=co,Q=!m;if(null==de){return !ci}for(de=cL(de);co--;){var da=ca[co];if(Q&&da[2]?da[1]!==de[da[0]]:!(da[0] in de)){return !1}}for(;++co<ci;){da=ca[co];var cu=da[0],cr=de[cu],cn=da[1];if(Q&&da[2]){if(cr===bd&&!(cu in de)){return !1}}else{var ce=m?m(cr,cn,cu):bd;if(!(ce===bd?d4(cn,cr,m,!0):ce)){return !1}}}return !0}function dG(m,ce){var Q=-1,ca=dl(m)?f6(m.length):[];return dZ(m,function(cn,ci,co){ca[++Q]=ce(cn,ci,co)}),ca}function A(m){var ce=hH(m);if(1==ce.length&&ce[0][2]){var Q=ce[0][0],ca=ce[0][1];return function(ci){return null!=ci&&(ci[Q]===ca&&(ca!==bd||Q in cL(ci)))}}return function(ci){return gG(ci,ce)}}function f7(Q,ci){var ca=hI(Q),ce=cp(Q)&&gH(ci),m=Q+"";return Q=dH(Q),function(co){if(null==co){return !1}var cn=m;if(co=cL(co),(ca||!ce)&&!(cn in co)){if(co=1==Q.length?co:ek(co,hX(Q,0,-1)),null==co){return !1}cn=eV(Q),co=cL(co)}return co[cn]===ci?ci!==bd||cn in co:d4(ci,co[cn],bd,!0)}}function hg(ca,co,ce,ci,Q){if(!fI(ca)){return ca}var cn=dl(co)&&(hI(co)||bX(co)),m=cn?bd:H(co);return d9(m||co,function(cu,di){if(m&&(di=cu,cu=co[di]),au(cu)){ci||(ci=[]),Q||(Q=[]),bW(ca,co,di,hg,ce,ci,Q)}else{var de=ca[di],cr=ce?ce(de,cu,di,ca,co):bd,da=cr===bd;da&&(cr=cu),cr===bd&&(!cn||di in ca)||!da&&(cr===cr?cr===de:de!==de)||(ca[di]=cr)}}),ca}function bW(de,ca,m,co,ci,Q,da){for(var cu=Q.length,cr=ca[m];cu--;){if(Q[cu]==cr){return void (de[m]=da[cu])}}var cn=de[m],ce=ci?ci(cn,cr,m,de,ca):bd,di=ce===bd;di&&(ce=cr,dl(cr)&&(hI(cr)||bX(cr))?ce=hI(cn)?cn:dl(cn)?ck(cn):[]:D(cr)||e3(cr)?ce=e3(cn)?dY(cn):D(cn)?cn:{}:di=!1),Q.push(cr),da.push(ce),di?de[m]=co(ce,cr,ci,Q,da):(ce===ce?ce!==cn:cn===cn)&&(de[m]=ce)}function hK(m){return function(Q){return null==Q?bd:Q[m]}}function dh(m){var Q=m+"";return m=dH(m),function(ca){return ek(ca,m,Q)}}function gV(Q,ci){for(var ca=Q?ci.length:0;ca--;){var ce=ci[ca];if(ce!=m&&cG(ce)){var m=ce;fL.call(Q,ce,1)}}return Q}function ij(m,Q){return m+h1(eN()*(Q-m+1))}function dV(Q,ci,ca,ce,m){return m(Q,function(co,cn,cr){ca=ce?(ce=!1,co):ci(ca,co,cn,cr)}),ca}function hX(Q,cn,ca){var ce=-1,m=Q.length;cn=null==cn?0:+cn||0,cn<0&&(cn=-cn>m?0:m+cn),ca=ca===bd||ca>m?m:+ca||0,ca<0&&(ca+=m),m=cn>ca?0:ca-cn>>>0,cn>>>=0;for(var ci=f6(m);++ce<m;){ci[ce]=Q[ce+cn]}return ci}function c5(m,ca){var Q;return dZ(m,function(ci,cn,ce){return Q=ca(ci,cn,ce),!Q}),!!Q}function dq(m,ca){var Q=m.length;for(m.sort(ca);Q--;){m[Q]=m[Q].value}return m}function cJ(Q,cn,ca){var ce=f4(),m=-1;cn=gj(cn,function(co){return ce(co)});var ci=dG(Q,function(co){var cr=gj(cn,function(cu){return cu(co)});return{criteria:cr,index:++m,value:co}});return dq(ci,function(co,cr){return aL(co,cr,ca)})}function fp(m,ca){var Q=0;return dZ(m,function(ci,cn,ce){Q+=+ca(ci,cn,ce)||0}),Q}function cg(de,ce){var m=-1,cr=bT(),cn=de.length,ca=cr==aS,da=ca&&cn>=bl,cu=da?gO():null,co=[];cu?(cr=dk,ca=!1):(da=!1,cu=ce?[]:co);de:for(;++m<cn;){var ci=de[m],di=ce?ce(ci,m,de):ci;if(ca&&ci===ci){for(var Q=cu.length;Q--;){if(cu[Q]===di){continue de}}ce&&cu.push(di),co.push(ci)}else{cr(cu,di,0)<0&&((ce||da)&&cu.push(di),co.push(ci))}}return co}function d6(Q,ci){for(var ca=-1,ce=ci.length,m=f6(ce);++ca<ce;){m[ca]=Q[ci[ca]]}return m}function cW(Q,cn,ca,ce){for(var m=Q.length,ci=ce?m:-1;(ce?ci--:++ci<m)&&cn(Q[ci],ci,Q);){}return ca?hX(Q,ce?0:ci,ce?ci+1:m):hX(Q,ce?ci+1:0,ce?m:ci)}function gA(Q,cn){var ca=Q;ca instanceof hd&&(ca=ca.value());for(var ce=-1,ci=cn.length;++ce<ci;){var m=cn[ce];ca=m.func.apply(m.thisArg,eM([ca],m.args))}return ca}function fy(ca,co,ce){var ci=0,Q=ca?ca.length:ci;if("number"==typeof co&&co===co&&Q<=L){for(;ci<Q;){var cn=ci+Q>>>1,m=ca[cn];(ce?m<=co:m<co)&&null!==m?ci=cn+1:Q=cn}return Q}return dO(ca,co,eC,ce)}function dO(dn,ce,m,cu){ce=m(ce);for(var cn=0,ca=dn?dn.length:0,di=ce!==ce,de=null===ce,da=ce===bd;cn<ca;){var cr=h1((cn+ca)/2),ci=m(dn[cr]),dr=ci!==bd,Q=ci===ci;if(di){var co=Q||cu}else{co=de?Q&&dr&&(cu||null!=ci):da?Q&&(cu||dr):null!=ci&&(cu?ci<=ce:ci<ce)}co?cn=cr+1:ca=cr}return fc(ca,e1)}function b0(m,ca,Q){if("function"!=typeof m){return eC}if(ca===bd){return m}switch(Q){case 1:return function(ce){return m.call(ca,ce)};case 3:return function(ci,cn,ce){return m.call(ca,ci,cn,ce)};case 4:return function(ci,cn,ce,co){return m.call(ca,ci,cn,ce,co)};case 5:return function(cn,co,ci,cr,ce){return m.call(ca,cn,co,ci,cr,ce)}}return function(){return m.apply(ca,arguments)}}function hM(m){var ca=new bY(m.byteLength),Q=new T(ca);return Q.set(new T(m)),ca}function g3(cu,ca,m){for(var ci=m.length,ce=-1,Q=hq(cu.length-ci,0),cr=-1,co=ca.length,cn=f6(co+Q);++cr<co;){cn[cr]=ca[cr]}for(;++ce<ci;){cn[m[ce]]=cu[ce]}for(;Q--;){cn[cr++]=cu[ce++]}return cn}function gg(de,ca,m){for(var co=-1,ci=m.length,Q=-1,da=hq(de.length-ci,0),cu=-1,cr=ca.length,cn=f6(da+cr);++Q<da;){cn[Q]=de[Q]}for(var ce=Q;++cu<cr;){cn[ce+cu]=ca[cu]}for(;++co<ci;){cn[ce+m[co]]=de[Q++]}return cn}function eK(m,Q){return function(cn,co,ci){var cr=Q?Q():{};if(co=f4(co,ci,3),hI(cn)){for(var ce=-1,ca=cn.length;++ce<ca;){var cu=cn[ce];m(cr,cu,co(cu,ce,cn),cn)}}else{dZ(cn,function(di,de,da){m(cr,di,co(di,de,da),da)})}return cr}}function cA(m){return f5(function(cu,ci){var cn=-1,ce=null==cu?0:ci.length,co=ce>2?ci[ce-2]:bd,ca=ce>2?ci[2]:bd,Q=ce>1?ci[ce-1]:bd;for("function"==typeof co?(co=b0(co,Q,5),ce-=2):(co="function"==typeof Q?Q:bd,ce-=co?1:0),ca&&fk(ci[0],ci[1],ca)&&(co=ce<3?bd:co,ce=1);++cn<ce;){var cr=ci[cn];cr&&m(cu,cr,co)}return cu})}function dz(m,Q){return function(ci,cn){var ce=ci?g7(ci):0;if(!c6(ce)){return m(ci,cn)}for(var co=Q?ce:-1,ca=cL(ci);(Q?co--:++co<ce)&&cn(ca[co],co,ca)!==!1;){}return ci}}function fM(m){return function(cu,ci,cn){for(var ce=cL(cu),co=cn(cu),ca=co.length,Q=m?ca:-1;m?Q--:++Q<ca;){var cr=co[Q];if(ci(ce[cr],cr,ce)===!1){break}}return cu}}function V(m,ce){function Q(){var ci=this&&this!==n&&this instanceof Q?ca:m;return ci.apply(ce,arguments)}var ca=f0(m);return Q}function gO(m){return fZ&&cy?new c1(m):null}function o(m){return function(cn){for(var ca=-1,ce=eZ(eL(cn)),Q=ce.length,ci="";++ca<Q;){ci=m(ci,ce[ca],ca)}return ci}}function f0(m){return function(){var ce=arguments;switch(ce.length){case 0:return new m;case 1:return new m(ce[0]);case 2:return new m(ce[0],ce[1]);case 3:return new m(ce[0],ce[1],ce[2]);case 4:return new m(ce[0],ce[1],ce[2],ce[3]);case 5:return new m(ce[0],ce[1],ce[2],ce[3],ce[4]);case 6:return new m(ce[0],ce[1],ce[2],ce[3],ce[4],ce[5]);case 7:return new m(ce[0],ce[1],ce[2],ce[3],ce[4],ce[5],ce[6])}var Q=eb(m.prototype),ca=m.apply(Q,ce);return fI(ca)?ca:Q}}function h3(m){function Q(ce,ci,ca){ca&&fk(ce,ci,ca)&&(ci=bd);var cn=cs(ce,m,bd,bd,bd,bd,bd,ci);return cn.placeholder=Q.placeholder,cn}return Q}function G(m,Q){return f5(function(ca){var ce=ca[0];return null==ce?ce:(ca.push(Q),m.apply(bd,ca))})}function ew(m,Q){return function(ce,ci,ca){if(ca&&fk(ce,ci,ca)&&(ci=bd),ci=f4(ci,ca,3),1==ci.length){ce=hI(ce)?ce:eS(ce);var cn=hP(ce,ci,m,Q);if(!ce.length||cn!==Q){return cn}}return eR(ce,ci,m,Q)}}function g(m,Q){return function(ce,ci,ca){if(ci=f4(ci,ca,3),hI(ce)){var cn=ay(ce,ci,Q);return cn>-1?ce[cn]:bd}return hB(ce,ci,m)}}function hs(m){return function(ce,Q,ca){return ce&&ce.length?(Q=f4(Q,ca,3),ay(ce,Q,m)):-1}}function fd(m){return function(ce,Q,ca){return Q=f4(Q,ca,3),hB(ce,Q,m,!0)}}function cM(m){return function(){for(var cu,ci=arguments.length,ce=m?ci:-1,co=0,ca=f6(ci);m?ce--:++ce<ci;){var Q=ca[co++]=arguments[ce];if("function"!=typeof Q){throw new c4(aD)}!cu&&hj.prototype.thru&&"wrapper"==hb(Q)&&(cu=new hj([],(!0)))}for(ce=cu?-1:ci;++ce<ci;){Q=ca[ce];var cr=hb(Q),cn="wrapper"==cr?f3(Q):bd;cu=cn&&el(cn[0])&&cn[1]==(bG|bs|bc|bv)&&!cn[4].length&&1==cn[9]?cu[hb(cn[0])].apply(cu,cn[3]):1==Q.length&&el(Q)?cu[cr]():cu.thru(Q)}return function(){var de=arguments,di=de[0];if(cu&&1==de.length&&hI(di)&&di.length>=bl){return cu.plant(di).value()}for(var da=0,dn=ci?ca[da].apply(this,de):di;++da<ci;){dn=ca[da].call(this,dn)}return dn}}}function eY(m,Q){return function(ce,ci,ca){return"function"==typeof ci&&ca===bd&&hI(ce)?m(ce,ci):Q(ce,b0(ci,ca,3))}}function eO(m){return function(ce,Q,ca){return"function"==typeof Q&&ca===bd||(Q=b0(Q,ca,3)),m(ce,Q,cj)}}function fQ(m){return function(ce,Q,ca){return"function"==typeof Q&&ca===bd||(Q=b0(Q,ca,3)),m(ce,Q)}}function eA(m){return function(ci,ca,ce){var Q={};return ca=f4(ca,ce,3),cb(ci,function(cu,co,cr){var cn=ca(cu,co,cr);co=m?cn:co,cu=m?cu:cn,Q[co]=cu}),Q}}function hy(m){return function(ce,Q,ca){return ce=aN(ce),(m?ce:"")+gl(ce,Q,ca)+(m?"":ce)}}function e2(m){var Q=f5(function(ce,ci){var ca=ar(ci,Q.placeholder);return cs(ce,m,bd,ci,ca)});return Q}function N(m,Q){return function(ci,cn,ce,co){var ca=arguments.length<3;return"function"==typeof cn&&co===bd&&hI(ci)?m(ci,cn,ce,ca):dV(ci,f4(cn,co,4),ce,ca,Q)}}function b7(ca,cr,ci,dr,da,co,Q,ec,ea,dn){function cu(){for(var fu=arguments.length,ge=fu,et=f6(fu);ge--;){et[ge]=arguments[ge]}if(dr&&(et=g3(et,dr,da)),co&&(et=gg(et,co,Q)),m||ee){var ga=cu.placeholder,fi=ar(et,ga);if(fu-=fi.length,fu<dn){var er=ec?ck(ec):bd,fa=hq(dn-fu,0),fe=m?fi:bd,eu=m?bd:fi,gi=m?et:bd,ei=m?bd:et;cr|=m?bc:a4,cr&=~(m?a4:bc),du||(cr&=~(bm|ba));var fo=[ca,cr,ci,gi,fe,ei,eu,er,ea,fa],fn=b7.apply(bd,fo);return el(ca)&&at(fn,fo),fn.placeholder=ga,fn}}var eo=cn?ci:this,fr=de?eo[ca]:ca;return ec&&(et=hh(et,ec)),ce&&ea<et.length&&(et.length=ea),this&&this!==n&&this instanceof cu&&(fr=di||f0(ca)),fr.apply(eo,et)}var ce=cr&bG,cn=cr&bm,de=cr&ba,m=cr&bs,du=cr&bq,ee=cr&bi,di=de?bd:f0(ca);return cu}function gl(Q,ci,ca){var ce=Q.length;if(ci=+ci,ce>=ci||!ev(ci)){return""}var m=ci-ce;return ca=null==ca?" ":ca+"",f1(ca,l(m/ca.length)).slice(0,m)}function fB(ca,co,ce,ci){function Q(){for(var dn=-1,cu=arguments.length,di=-1,de=ci.length,cr=f6(de+cu);++di<de;){cr[di]=ci[di]}for(;cu--;){cr[di++]=arguments[++dn]}var da=this&&this!==n&&this instanceof Q?m:ca;return da.apply(cn?ce:this,cr)}var cn=co&bm,m=f0(ca);return Q}function ef(m){var Q=dg[m];return function(ca,ce){return ce=ce===bd?0:+ce||0,ce?(ce=gf(10,ce),Q(ca*ce)/ce):Q(ca)}}function d1(m){return function(cn,ca,ce,Q){var ci=f4(ce);return null==ce&&ci===k?fy(cn,ca,m):dO(cn,ca,ci(ce,Q,1),m)}}function cs(du,ce,m,cu,cn,ca,dr,di){var de=ce&ba;if(!de&&"function"!=typeof du){throw new c4(aD)}var cr=cu?cu.length:0;if(cr||(ce&=~(bc|a4),cu=cn=bd),cr-=cn?cn.length:0,ce&a4){var ci=cu,ea=cn;cu=cn=bd}var Q=de?bd:f3(du),co=[du,ce,m,cu,cn,ci,ea,ca,dr,di];if(Q&&(fF(co,Q),ce=co[1],di=co[9]),co[9]=null==di?de?0:du.length:hq(di-cr,0)||0,ce==bm){var dn=V(co[0],co[2])}else{dn=ce!=bc&&ce!=(bm|bc)||co[4].length?b7.apply(bd,co):fB.apply(bd,co)}var da=Q?u:at;return da(dn,co)}function gD(di,ce,m,cr,cn,ca,de){var da=-1,cu=di.length,co=ce.length;if(cu!=co&&!(cn&&co>cu)){return !1}for(;++da<cu;){var ci=di[da],dn=ce[da],Q=cr?cr(cn?dn:ci,cn?ci:dn,da):bd;if(Q!==bd){if(Q){continue}return !1}if(cn){if(!fO(ce,function(dr){return ci===dr||m(ci,dr,cr,cn,ca,de)})){return !1}}else{if(ci!==dn&&!m(ci,dn,cr,cn,ca,de)){return !1}}}return !0}function dD(m,ca,Q){switch(Q){case bn:case aX:return +m==+ca;case aZ:return m.name==ca.name&&m.message==ca.message;case a6:return m!=+m?ca!=+ca:m==+ca;case bL:case an:return m==ca+""}return !1}function w(ce,cu,cn,du,de,cr,ca){var ee=H(ce),ec=ee.length,dr=H(cu),da=dr.length;if(ec!=da&&!de){return !1}for(var ci=ec;ci--;){var co=ee[ci];if(!(de?co in cu:d5.call(cu,co))){return !1}}for(var di=de;++ci<ec;){co=ee[ci];var Q=ce[co],ea=cu[co],ei=du?du(de?ea:Q,de?Q:ea,co):bd;if(!(ei===bd?cn(Q,ea,du,de,cr,ca):ei)){return !1}di||(di="constructor"==co)}if(!di){var dn=ce.constructor,m=cu.constructor;if(dn!=m&&"constructor" in ce&&"constructor" in cu&&!("function"==typeof dn&&dn instanceof dn&&"function"==typeof m&&m instanceof m)){return !1}}return !0}function f4(Q,ca,ce){var m=g8.callback||eQ;return m=m===eQ?k:m,ce?m(Q,ca,ce):m}function hb(Q){for(var cn=Q.name,ca=fA[cn],ce=ca?ca.length:0;ce--;){var m=ca[ce],ci=m.func;if(null==ci||ci==Q){return m.name}}return cn}function bT(Q,ca,ce){var m=g8.indexOf||cV;return m=m===cV?aS:m,Q?m(Q,ca,ce):m}function hH(m){for(var ca=d8(m),Q=ca.length;Q--;){ca[Q][2]=gH(ca[Q][1])}return ca}function df(m,ca){var Q=null==m?bd:m[ca];return cx(Q)?Q:bd}function gS(ca,co,ce){for(var ci=-1,Q=ce.length;++ci<Q;){var cn=ce[ci],m=cn.size;switch(cn.type){case"drop":ca+=m;break;case"dropRight":co-=m;break;case"take":co=fc(co,ca+m);break;case"takeRight":ca=hq(ca,co-m)}}return{start:ca,end:co}}function id(m){var ca=m.length,Q=new m.constructor(ca);return ca&&"string"==typeof m[0]&&d5.call(m,"index")&&(Q.index=m.index,Q.input=m.input),Q}function dS(m){var Q=m.constructor;return"function"==typeof Q&&Q instanceof Q||(Q=ih),new Q}function hT(Q,cn,ca){var ce=Q.constructor;switch(cn){case aA:return hM(Q);case bn:case aX:return new ce((+Q));case bu:case am:case bH:case bJ:case bB:case ah:case aU:case aj:case ae:var m=Q.buffer;return new ce(ca?hM(m):m,Q.byteOffset,Q.length);case a6:case an:return new ce(Q);case bL:var ci=new ce(Q.source,aC.exec(Q));ci.lastIndex=Q.lastIndex}return ci}function c2(m,ce,Q){null==m||cp(ce,m)||(ce=dH(ce),m=1==ce.length?m:ek(m,hX(ce,0,-1)),ce=eV(ce));var ca=null==m?m:m[ce];return null==ca?bd:ca.apply(m,Q)}function dl(m){return null!=m&&c6(g7(m))}function cG(m,Q){return m="number"==typeof m||by.test(m)?+m:-1,Q=null==Q?b5:Q,m>-1&&m%1==0&&m<Q}function fk(Q,ci,ca){if(!fI(ca)){return !1}var ce=typeof ci;if("number"==ce?dl(ca)&&cG(ci,ca.length):"string"==ce&&ci in ca){var m=ca[ci];return Q===Q?Q===m:m!==m}return !1}function cp(m,ce){var Q=typeof m;if("string"==Q&&a9.test(m)||"number"==Q){return !0}if(hI(m)){return !1}var ca=!bP.test(m);return ca||null!=ce&&m in cL(ce)}function el(m){var Q=hb(m);if(!(Q in hd.prototype)){return !1}var ca=g8[Q];if(m===ca){return !0}var ce=f3(ca);return !!ce&&m===ce[0]}function c6(m){return"number"==typeof m&&m>-1&&m%1==0&&m<=b5}function gH(m){return m===m&&!fI(m)}function fF(cu,ca){var m=cu[1],ci=ca[1],ce=m|ci,Q=ce<bG,cr=ci==bG&&m==bs||ci==bG&&m==bv&&cu[7].length<=ca[8]||ci==(bG|bv)&&m==bs;if(!Q&&!cr){return cu}ci&bm&&(cu[2]=ca[2],ce|=m&bm?0:bq);var co=ca[3];if(co){var cn=cu[3];cu[3]=cn?g3(cn,co,ca[4]):ck(co),cu[4]=cn?ar(cu[3],bk):ck(ca[4])}return co=ca[5],co&&(cn=cu[5],cu[5]=cn?gg(cn,co,ca[6]):ck(co),cu[6]=cn?ar(cu[5],bk):ck(ca[6])),co=ca[7],co&&(cu[7]=ck(co)),ci&bG&&(cu[8]=null==cu[8]?ca[8]:fc(cu[8],ca[8])),null==cu[9]&&(cu[9]=ca[9]),cu[0]=ca[0],cu[1]=ce,cu}function dW(m,Q){return m===bd?Q:fb(m,Q,dW)}function b6(Q,cn){Q=cL(Q);for(var ca=-1,ce=cn.length,m={};++ca<ce;){var ci=cn[ca];ci in Q&&(m[ci]=Q[ci])}return m}function hY(m,ca){var Q={};return R(m,function(ci,cn,ce){ca(ci,cn,ce)&&(Q[cn]=ci)}),Q}function hh(Q,cn){for(var ca=Q.length,ce=fc(cn.length,ca),m=ck(Q);ce--;){var ci=cn[ce];Q[ce]=cG(ci,ca)?m[ci]:bd}return Q}function gs(ce){for(var cr=cj(ce),ci=cr.length,cn=ci&&ce.length,ca=!!cn&&c6(cn)&&(hI(ce)||e3(ce)),co=-1,Q=[];++co<ci;){var m=cr[co];(ca&&cG(m,cn)||d5.call(ce,m))&&Q.push(m)}return Q}function eS(m){return null==m?[]:dl(m)?fI(m)?m:ih(m):dP(m)}function cL(m){return fI(m)?m:ih(m)}function dH(m){if(hI(m)){return m}var Q=[];return aN(m).replace(bE,function(ce,ci,cn,ca){Q.push(cn?ca.replace(aV,"$1"):ci||ce)}),Q}function fU(m){return m instanceof hd?m.clone():new hj(m.__wrapped__,m.__chain__,ck(m.__actions__))}function bt(ca,co,ce){co=(ce?fk(ca,co,ce):null==co)?1:hq(h1(co)||1,1);for(var ci=0,Q=ca?ca.length:0,cn=-1,m=f6(l(Q/co));ci<Q;){m[++cn]=hX(ca,ci,ci+=co)}return m}function gW(Q){for(var cn=-1,ca=Q?Q.length:0,ce=-1,m=[];++cn<ca;){var ci=Q[cn];ci&&(m[++ce]=ci)}return m}function B(m,ce,Q){var ca=m?m.length:0;return ca?((Q?fk(m,ce,Q):null==ce)&&(ce=1),hX(m,ce<0?0:ce)):[]}function f8(m,ce,Q){var ca=m?m.length:0;return ca?((Q?fk(m,ce,Q):null==ce)&&(ce=1),ce=ca-(+ce||0),hX(m,0,ce<0?0:ce)):[]}function h9(m,ca,Q){return m&&m.length?cW(m,f4(ca,Q,3),!0,!0):[]}function M(m,ca,Q){return m&&m.length?cW(m,f4(ca,Q,3),!0):[]}function eE(Q,ci,ca,ce){var m=Q?Q.length:0;return m?(ca&&"number"!=typeof ca&&fk(Q,ci,ca)&&(ca=0,ce=m),fT(Q,ci,ca,ce)):[]}function v(m){return m?m[0]:bd}function hC(m,ce,Q){var ca=m?m.length:0;return Q&&fk(m,ce,Q)&&(ce=!1),ca?e5(m,ce):[]}function fq(m){var Q=m?m.length:0;return Q?e5(m,!0):[]}function cV(Q,ci,ca){var ce=Q?Q.length:0;if(!ce){return -1}if("number"==typeof ca){ca=ca<0?hq(ce+ca,0):ca}else{if(ca){var m=fy(Q,ci);return m<ce&&(ci===ci?ci===Q[m]:Q[m]!==Q[m])?m:-1}}return aS(Q,ci,ca||0)}function e6(m){return f8(m,1)}function eV(m){var Q=m?m.length:0;return Q?m[Q-1]:bd}function fX(Q,cn,ca){var ce=Q?Q.length:0;if(!ce){return -1}var m=ce;if("number"==typeof ca){m=(ca<0?hq(ce+ca,0):fc(ca||0,ce-1))+1}else{if(ca){m=fy(Q,cn,!0)-1;var ci=Q[m];return(cn===cn?cn===ci:ci!==ci)?m:-1}}if(cn!==cn){return aq(Q,m,!0)}for(;m--;){if(Q[m]===cn){return m}}return -1}function eH(){var ca=arguments,co=ca[0];if(!co||!co.length){return co}for(var ce=0,ci=bT(),Q=ca.length;++ce<Q;){for(var cn=0,m=ca[ce];(cn=ci(co,m,cn))>-1;){fL.call(co,cn,1)}}return co}function hG(ce,cr,ci){var cn=[];if(!ce||!ce.length){return cn}var ca=-1,co=[],Q=ce.length;for(cr=f4(cr,ci,3);++ca<Q;){var m=ce[ca];cr(m,ca,ce)&&(cn.push(m),co.push(ca))}return gV(ce,co),cn}function e9(m){return B(m,1)}function U(m,ce,Q){var ca=m?m.length:0;return ca?(Q&&"number"!=typeof Q&&fk(m,ce,Q)&&(ce=0,Q=ca),hX(m,ce,Q)):[]}function cf(m,ce,Q){var ca=m?m.length:0;return ca?((Q?fk(m,ce,Q):null==ce)&&(ce=1),hX(m,0,ce<0?0:ce)):[]}function gw(m,ce,Q){var ca=m?m.length:0;return ca?((Q?fk(m,ce,Q):null==ce)&&(ce=1),ce=ca-(+ce||0),hX(m,ce<0?0:ce)):[]}function fJ(m,ca,Q){return m&&m.length?cW(m,f4(ca,Q,3),!1,!0):[]}function eq(m,ca,Q){return m&&m.length?cW(m,f4(ca,Q,3)):[]}function ed(Q,cn,ca,ce){var m=Q?Q.length:0;if(!m){return[]}null!=cn&&"boolean"!=typeof cn&&(ce=ca,ca=fk(Q,cn,ce)?bd:cn,cn=!1);var ci=f4();return null==ca&&ci===k||(ca=ci(ca,ce,3)),cn&&bT()==aS?aR(Q,ca):cg(Q,ca)}function cz(m){if(!m||!m.length){return[]}var ce=-1,Q=0;m=g6(m,function(ci){if(dl(ci)){return Q=hq(ci.length,Q),!0}});for(var ca=f6(Q);++ce<Q;){ca[ce]=gj(m,hK(ce))}return ca}function gL(Q,ci,ca){var ce=Q?Q.length:0;if(!ce){return[]}var m=cz(Q);return null==ci?m:(ci=b0(ci,ca,4),gj(m,function(cn){return cD(cn,ci,bd,!0)}))}function dK(){for(var m=-1,ce=arguments.length;++m<ce;){var Q=arguments[m];if(dl(Q)){var ca=ca?eM(cQ(ca,Q),cQ(Q,ca)):Q}}return ca?cg(ca):[]}function F(Q,cn){var ca=-1,ce=Q?Q.length:0,m={};for(!ce||cn||hI(Q[0])||(cn=[]);++ca<ce;){var ci=Q[ca];cn?m[ci]=cn[ca]:ci&&(m[ci[0]]=ci[1])}return m}function gc(m){var Q=g8(m);return Q.__chain__=!0,Q}function hm(m,ca,Q){return ca.call(Q,m),m}function bZ(m,ca,Q){return ca.call(Q,m)}function hR(){return gc(this)}function ds(){return new hj(this.value(),this.__chain__)}function gZ(Q){for(var ci,ca=this;ca instanceof g4;){var m=fU(ca);ci?ce.__wrapped__=m:ci=m;var ce=m;ca=ca.__wrapped__}return ce.__wrapped__=Q,ci}function im(){var m=this.__wrapped__,ca=function(ce){return Q&&Q.__dir__<0?ce:ce.reverse()};if(m instanceof hd){var Q=m;return this.__actions__.length&&(Q=new hd(this)),Q=Q.reverse(),Q.__actions__.push({func:bZ,args:[ca],thisArg:bd}),new hj(Q,this.__chain__)}return this.thru(ca)}function d0(){return this.value()+""}function h2(){return gA(this.__wrapped__,this.__actions__)}function db(m,ce,Q){var ca=hI(m)?b3:e0;return Q&&fk(m,ce,Q)&&(ce=bd),"function"==typeof ce&&Q===bd||(ce=f4(ce,Q,3)),ca(m,ce)}function dw(m,ce,Q){var ca=hI(m)?g6:eD;return ce=f4(ce,Q,3),ca(m,ce)}function cR(m,Q){return fH(m,A(Q))}function fv(Q,ci,ca,ce){var m=Q?g7(Q):0;return c6(m)||(Q=dP(Q),m=Q.length),ca="number"!=typeof ca||ce&&fk(ci,ca,ce)?0:ca<0?hq(m+ca,0):ca||0,"string"==typeof Q||!hI(Q)&&hl(Q)?ca<=m&&Q.indexOf(ci,ca)>-1:!!m&&bT(Q,ci,ca)>-1}function cl(m,ce,Q){var ca=hI(m)?gj:dG;return ce=f4(ce,Q,3),ca(m,ce)}function eg(m,Q){return cl(m,fD(Q))}function c3(m,ce,Q){var ca=hI(m)?g6:eD;return ce=f4(ce,Q,3),ca(m,function(ci,cn,co){return !ce(ci,cn,co)})}function gE(cu,ca,m){if(m?fk(cu,ca,m):null==ca){cu=eS(cu);var ci=cu.length;return ci>0?cu[ij(0,ci-1)]:bd}var ce=-1,Q=ik(cu),ci=Q.length,cr=ci-1;for(ca=fc(ca<0?0:+ca||0,ci);++ce<ca;){var co=ij(ce,cr),cn=Q[co];Q[co]=Q[ce],Q[ce]=cn}return Q.length=ca,Q}function fC(m){return gE(m,ez)}function dT(m){var Q=m?g7(m):0;return c6(Q)?Q:H(m).length}function b4(m,ce,Q){var ca=hI(m)?fO:c5;return Q&&fk(m,ce,Q)&&(ce=bd),"function"==typeof ce&&Q===bd||(ce=f4(ce,Q,3)),ca(m,ce)}function hV(Q,ci,ca){if(null==Q){return[]}ca&&fk(Q,ci,ca)&&(ci=bd);var ce=-1;ci=f4(ci,ca,3);var m=dG(Q,function(co,cr,cn){return{criteria:ci(co,cr,cn),index:++ce,value:co}});return dq(m,aE)}function hc(m,ce,Q,ca){return null==m?[]:(ca&&fk(ce,Q,ca)&&(Q=bd),hI(ce)||(ce=null==ce?[]:[ce]),hI(Q)||(Q=null==Q?[]:[Q]),cJ(m,ce,Q))}function gm(m,Q){return dw(m,A(Q))}function eP(m,ca){if("function"!=typeof ca){if("function"!=typeof m){throw new c4(aD)}var Q=m;m=ca,ca=Q}return m=ev(m=+m)?m:0,function(){if(--m<1){return ca.apply(this,arguments)}}}function cH(m,ca,Q){return Q&&fk(m,ca,Q)&&(ca=bd),ca=m&&null==ca?m.length:hq(+ca||0,0),cs(m,bG,bd,bd,bd,bd,ca)}function dE(m,ce){var Q;if("function"!=typeof ce){if("function"!=typeof m){throw new c4(aD)}var ca=m;m=ce,ce=ca}return function(){return --m>0&&(Q=ce.apply(this,arguments)),m<=1&&(ce=bd),Q}}function fR(ce,cu,cn){function du(){di&&hL(di),dr&&hL(dr),ea=0,dr=di=Q=bd}function de(er,eo){eo&&hL(eo),dr=di=Q=bd,er&&(ea=gX(),da=ce.apply(co,ec),di||dr||(ec=co=bd))}function cr(){var eo=cu-(gX()-ci);eo<=0||eo>cu?de(Q,dr):di=dy(cr,eo)}function ca(){de(dn,di)}function ee(){if(ec=arguments,ci=gX(),co=this,Q=dn&&(di||!m),ei===!1){var er=m&&!di}else{dr||m||(ea=ci);var et=ei-(ci-ea),eo=et<=0||et>ei;eo?(dr&&(dr=hL(dr)),ea=ci,da=ce.apply(co,ec)):dr||(dr=dy(ca,et))}return eo&&di?di=hL(di):di||cu===ei||(di=dy(cr,cu)),er&&(eo=!0,da=ce.apply(co,ec)),!eo||di||dr||(ec=co=bd),da}var ec,dr,da,ci,co,di,Q,ea=0,ei=!1,dn=!0;if("function"!=typeof ce){throw new c4(aD)}if(cu=cu<0?0:+cu||0,cn===!0){var m=!0;dn=!1}else{fI(cn)&&(m=!!cn.leading,ei="maxWait" in cn&&hq(+cn.maxWait||0,cu),dn="trailing" in cn?!!cn.trailing:dn)}return ee.cancel=du,ee}function Z(m,ca){if("function"!=typeof m||ca&&"function"!=typeof ca){throw new c4(aD)}var Q=function(){var cn=arguments,ci=ca?ca.apply(this,cn):cn[0],co=Q.cache;if(co.has(ci)){return co.get(ci)}var ce=m.apply(this,cn);return Q.cache=co.set(ci,ce),ce};return Q.cache=new Z.Cache,Q}function gT(m){if("function"!=typeof m){throw new c4(aD)}return function(){return !m.apply(this,arguments)}}function y(m){return dE(2,m)}function f5(m,Q){if("function"!=typeof m){throw new c4(aD)}return Q=hq(Q===bd?m.length-1:+Q||0,0),function(){for(var ci=arguments,cn=-1,ce=hq(ci.length-Q,0),co=f6(ce);++cn<ce;){co[cn]=ci[Q+cn]}switch(Q){case 0:return m.call(this,co);case 1:return m.call(this,ci[0],co);case 2:return m.call(this,ci[0],ci[1],co)}var ca=f6(Q+1);for(cn=-1;++cn<Q;){ca[cn]=ci[cn]}return ca[Q]=co,m.apply(this,ca)}}function h7(m){if("function"!=typeof m){throw new c4(aD)}return function(Q){return m.apply(this,Q)}}function K(Q,ci,ca){var ce=!0,m=!0;if("function"!=typeof Q){throw new c4(aD)}return ca===!1?ce=!1:fI(ca)&&(ce="leading" in ca?!!ca.leading:ce,m="trailing" in ca?!!ca.trailing:m),fR(Q,ci,{leading:ce,maxWait:+ci,trailing:m})}function eB(m,Q){return Q=null==Q?eC:Q,cs(Q,bc,bd,[m],[])}function p(m,ce,Q,ca){return ce&&"boolean"!=typeof ce&&fk(m,ce,Q)?ce=!1:"function"==typeof ce&&(ca=Q,Q=ce,ce=!1),"function"==typeof Q?hw(m,ce,b0(Q,ca,1)):hw(m,ce)}function hz(m,ca,Q){return"function"==typeof ca?hw(m,!0,b0(ca,Q,1)):hw(m,!0)}function fl(m,Q){return m>Q}function cT(m,Q){return m>=Q}function e3(m){return au(m)&&dl(m)&&d5.call(m,"callee")&&!eJ.call(m,"callee")}function eU(m){return m===!0||m===!1||au(m)&&gy.call(m)==bn}function fW(m){return au(m)&&gy.call(m)==aX}function eG(m){return !!m&&1===m.nodeType&&au(m)&&!D(m)}function hE(m){return null==m||(dl(m)&&(hI(m)||hl(m)||e3(m)||au(m)&&gv(m.splice))?!m.length:!H(m).length)}function e8(Q,ci,ca,ce){ca="function"==typeof ca?b0(ca,ce,3):bd;var m=ca?ca(Q,ci):bd;return m===bd?d4(Q,ci,ca):!!m}function S(m){return au(m)&&"string"==typeof m.message&&gy.call(m)==aZ}function cc(m){return"number"==typeof m&&ev(m)}function gv(m){return fI(m)&&gy.call(m)==aW}function fI(m){var Q=typeof m;return !!m&&("object"==Q||"function"==Q)}function ep(m,ce,Q,ca){return Q="function"==typeof Q?b0(Q,ca,3):bd,gG(m,hH(ce),Q)}function d7(m){return dJ(m)&&m!=+m}function cx(m){return null!=m&&(gv(m)?dM.test(cd.call(m)):au(m)&&a2.test(m))}function gK(m){return null===m}function dJ(m){return"number"==typeof m||au(m)&&gy.call(m)==a6}function D(m){var ca;if(!au(m)||gy.call(m)!=aY||e3(m)||!d5.call(m,"constructor")&&(ca=m.constructor,"function"==typeof ca&&!(ca instanceof ca))){return !1}var Q;return R(m,function(ce,ci){Q=ci}),Q===bd||d5.call(m,Q)}function gb(m){return fI(m)&&gy.call(m)==bL}function hl(m){return"string"==typeof m||au(m)&&gy.call(m)==an}function bX(m){return au(m)&&c6(m.length)&&!!be[gy.call(m)]}function hN(m){return m===bd}function dm(m,Q){return m<Q}function gY(m,Q){return m<=Q}function ik(m){var Q=m?g7(m):0;return c6(Q)?Q?ck(m):[]:dP(m)}function dY(m){return ey(m,cj(m))}function h0(m,ce,Q){var ca=eb(m);return Q&&fk(m,ce,Q)&&(ce=bd),ce?h6(ca,ce):ca}function c9(m){return fE(m,cj(m))}function dv(m,ce,Q){var ca=null==m?bd:ek(m,dH(ce),ce+"");return ca===bd?Q:ca}function cO(m,ca){if(null==m){return !1}var Q=d5.call(m,ca);if(!Q&&!cp(ca)){if(ca=dH(ca),m=1==ca.length?m:ek(m,hX(ca,0,-1)),null==m){return !1}ca=eV(ca),Q=d5.call(m,ca)}return Q||c6(m.length)&&cG(ca,m.length)&&(hI(m)||e3(m))}function ft(cu,ca,m){m&&fk(cu,ca,m)&&(ca=bd);for(var ci=-1,ce=H(cu),Q=ce.length,cr={};++ci<Q;){var co=ce[ci],cn=cu[co];ca?d5.call(cr,cn)?cr[cn].push(co):cr[cn]=[co]:cr[cn]=co}return cr}function cj(ce){if(null==ce){return[]}fI(ce)||(ce=ih(ce));var cr=ce.length;cr=cr&&c6(cr)&&(hI(ce)||e3(ce))&&cr||0;for(var ci=ce.constructor,cn=-1,ca="function"==typeof ci&&ci.prototype===ce,co=f6(cr),Q=cr>0;++cn<cr;){co[cn]=cn+""}for(var m in ce){Q&&cG(m,cr)||"constructor"==m&&(ca||!d5.call(ce,m))||co.push(m)}return co}function d8(Q){Q=cL(Q);for(var cn=-1,ca=H(Q),ce=ca.length,m=f6(ce);++cn<ce;){var ci=ca[cn];m[cn]=[ci,Q[ci]]}return m}function cY(m,ce,Q){var ca=null==m?bd:m[ce];return ca===bd&&(null==m||cp(ce,m)||(ce=dH(ce),m=1==ce.length?m:ek(m,hX(ce,0,-1)),ca=null==m?bd:m[eV(ce)]),ca=ca===bd?Q:ca),gv(ca)?ca.call(m):ca}function gB(cu,ca,m){if(null==cu){return cu}var ci=ca+"";ca=null!=cu[ci]||cp(ca,cu)?[ci]:dH(ca);for(var ce=-1,Q=ca.length,cr=Q-1,co=cu;null!=co&&++ce<Q;){var cn=ca[ce];fI(co)&&(ce==cr?co[cn]=m:null==co[cn]&&(co[cn]=cG(ca[ce+1])?[]:{})),co=co[cn]}return cu}function fz(Q,cn,ca,ce){var m=hI(Q)||bX(Q);if(cn=f4(cn,ce,4),null==ca){if(m||fI(Q)){var ci=Q.constructor;ca=m?hI(Q)?new ci:[]:eb(gv(ci)?ci.prototype:bd)}else{ca={}}}return(m?d9:cb)(Q,function(cr,cu,co){return cn(ca,cr,cu,co)}),ca}function dP(m){return d6(m,H(m))}function b2(m){return d6(m,cj(m))}function hO(m,ca,Q){return ca=+ca||0,Q===bd?(Q=ca,ca=0):Q=+Q||0,m>=fc(ca,Q)&&m<hq(ca,Q)}function g5(Q,cn,ca){ca&&fk(Q,cn,ca)&&(cn=ca=bd);var ce=null==Q,m=null==cn;if(null==ca&&(m&&"boolean"==typeof Q?(ca=Q,Q=1):"boolean"==typeof cn&&(ca=cn,m=!0)),ce&&m&&(cn=1,m=!1),Q=+Q||0,m?(cn=Q,Q=0):cn=+cn||0,ca||Q%1||cn%1){var ci=eN();return fc(Q+ci*(cn-Q+g1("1e-"+((ci+"").length-1))),cn)}return ij(Q,cn)}function gh(m){return m=aN(m),m&&m.charAt(0).toUpperCase()+m.slice(1)}function eL(m){return m=aN(m),m&&m.replace(aa,ax).replace(ag,"")}function cC(m,ce,Q){m=aN(m),ce+="";var ca=m.length;return Q=Q===bd?ca:fc(Q<0?0:+Q||0,ca),Q-=ce.length,Q>=0&&m.indexOf(ce,Q)==Q}function dA(m){return m=aN(m),m&&aQ.test(m)?m.replace(bz,aO):m}function fN(m){return m=aN(m),m&&ac.test(m)?m.replace(a0,aT):m||"(?:)"}function X(ca,co,ce){ca=aN(ca),co=+co;var ci=ca.length;if(ci>=co||!ev(co)){return ca}var Q=(co-ci)/2,cn=h1(Q),m=l(Q);return ce=gl("",m,ce),ce.slice(0,cn)+ca+ce}function q(m,ca,Q){return(Q?fk(m,ca,Q):null==ca)?ca=0:ca&&(ca=+ca),m=ex(m),eX(m,ca||(bh.test(m)?16:10))}function f1(m,ca){var Q="";if(m=aN(m),ca=+ca,ca<1||!m||!ev(ca)){return Q}do{ca%2&&(Q+=m),ca=h1(ca/2),m+=m}while(ca);return Q}function h5(m,ca,Q){return m=aN(m),Q=null==Q?0:fc(Q<0?0:+Q||0,m.length),m.lastIndexOf(ca,Q)==Q}function I(du,m,co){var ci=g8.templateSettings;co&&fk(du,m,co)&&(m=co=bd),du=aN(du),m=f2(h6({},co||m),ci,s);var ca,dr,de=f2(h6({},m.imports),ci.imports,s),cu=H(de),ce=d6(de,cu),ea=0,Q=m.interpolate||al,cn="__p += '",dn=dU((m.escape||al).source+"|"+Q.source+"|"+(Q===i?bM:al).source+"|"+(m.evaluate||al).source+"|$","g"),cr="//# sourceURL="+("sourceURL" in m?m.sourceURL:"lodash.templateSources["+ ++ao+"]")+"\n";du.replace(dn,function(et,ei,eo,ee,ec,er){return eo||(eo=ee),cn+=du.slice(ea,er).replace(r,aM),ei&&(ca=!0,cn+="' +\n__e("+ei+") +\n'"),ec&&(dr=!0,cn+="';\n"+ec+";\n__p += '"),eo&&(cn+="' +\n((__t = ("+eo+")) == null ? '' : __t) +\n'"),ea=er+et.length,et}),cn+="';\n";var di=m.variable;di||(cn="with (obj) {\n"+cn+"\n}\n"),cn=(dr?cn.replace(bR,""):cn).replace(bx,"$1").replace(bD,"$1;"),cn="function("+(di||"obj")+") {\n"+(di?"":"obj || (obj = {});\n")+"var __t, __p = ''"+(ca?", __e = _.escape":"")+(dr?", __j = Array.prototype.join;\nfunction print() { __p += __j.call(arguments, '') }\n":";\n")+cn+"return __p\n}";var da=dx(function(){return hJ(cu,cr+"return "+cn).apply(bd,ce)});if(da.source=cn,S(da)){throw da}return da}function ex(m,ce,Q){var ca=m;return(m=aN(m))?(Q?fk(ca,ce,Q):null==ce)?m.slice(aK(m),bw(m)+1):(ce+="",m.slice(aI(m,ce),az(m,ce)+1)):m}function j(m,ce,Q){var ca=m;return m=aN(m),m?(Q?fk(ca,ce,Q):null==ce)?m.slice(aK(m)):m.slice(aI(m,ce+"")):m}function hv(m,ce,Q){var ca=m;return m=aN(m),m?(Q?fk(ca,ce,Q):null==ce)?m.slice(0,bw(m)+1):m.slice(0,az(m,ce+"")+1):m}function ff(de,ce,m){m&&fk(de,ce,m)&&(ce=bd);var co=bj,cn=a1;if(null!=ce){if(fI(ce)){var ca="separator" in ce?ce.separator:ca;co="length" in ce?+ce.length||0:co,cn="omission" in ce?aN(ce.omission):cn}else{co=+ce||0}}if(de=aN(de),co>=de.length){return de}var da=co-cn.length;if(da<1){return cn}var cu=de.slice(0,da);if(null==ca){return cu+cn}if(gb(ca)){if(de.slice(da).search(ca)){var cr,ci,di=de.slice(0,da);for(ca.global||(ca=dU(ca.source,(aC.exec(ca)||"")+"g")),ca.lastIndex=0;cr=ca.exec(di);){ci=cr.index}cu=cu.slice(0,null==ci?da:ci)}}else{if(de.indexOf(ca,da)!=da){var Q=cu.lastIndexOf(ca);Q>-1&&(cu=cu.slice(0,Q))}}return cu+cn}function cP(m){return m=aN(m),m&&bN.test(m)?m.replace(ab,aJ):m}function eZ(m,ca,Q){return Q&&fk(m,ca,Q)&&(ca=bd),m=aN(m),m.match(ca||bC)||[]}function eQ(m,ca,Q){return Q&&fk(m,ca,Q)&&(ca=bd),au(m)?hA(m):k(m,ca)}function fS(m){return function(){return m}}function eC(m){return m}function hA(m){return A(hw(m,!0))}function e4(m,Q){return f7(m,hw(Q,!0))}function P(de,ca,m){if(null==m){var co=fI(ca),ci=co?H(ca):bd,Q=ci&&ci.length?fE(ca,ci):bd;(Q?Q.length:co)||(Q=!1,m=ca,ca=de,de=this)}Q||(Q=fE(ca,H(ca)));var da=!0,cu=-1,cr=gv(de),cn=Q.length;m===!1?da=!1:fI(m)&&"chain" in m&&(da=m.chain);for(;++cu<cn;){var ce=Q[cu],di=ca[ce];de[ce]=di,cr&&(de.prototype[ce]=function(dn){return function(){var du=this.__chain__;if(da||du){var ea=de(this.__wrapped__),dr=ea.__actions__=ck(this.__actions__);return dr.push({func:dn,args:arguments,thisArg:de}),ea.__chain__=du,ea}return dn.apply(de,eM([this.value()],arguments))}}(di))}return de}function b9(){return n._=fx,this}function gp(){}function fD(m){return cp(m)?hK(m):dh(m)}function ej(m){return function(Q){return ek(m,dH(Q),Q+"")}}function d3(Q,cn,ca){ca&&fk(Q,cn,ca)&&(cn=ca=bd),Q=+Q||0,ca=null==ca?1:+ca||0,null==cn?(cn=Q,Q=0):cn=+cn||0;for(var ce=-1,m=hq(l((cn-Q)/(ca||1)),0),ci=f6(m);++ce<m;){ci[ce]=Q,Q+=ca}return ci}function cv(Q,ci,ca){if(Q=h1(Q),Q<1||!ev(Q)){return[]}var ce=-1,m=f6(fc(Q,hx));for(ci=b0(ci,ca,1);++ce<Q;){ce<hx?m[ce]=ci(ce):ci(ce)}return m}function gF(m){var Q=++cU;return aN(m)+Q}function dF(m,Q){return(+m||0)+(+Q||0)}function z(m,ca,Q){return Q&&fk(m,ca,Q)&&(ca=bd),ca=f4(ca,Q,3),1==ca.length?Y(hI(m)?m:eS(m),ca):fp(m,ca)}g2=g2?aB.defaults(n.Object(),g2,aB.pick(n,aw)):n;var f6=g2.Array,hf=g2.Date,bV=g2.Error,hJ=g2.Function,dg=g2.Math,gU=g2.Number,ih=g2.Object,dU=g2.RegExp,hW=g2.String,c4=g2.TypeError,dp=f6.prototype,cI=ih.prototype,fm=hW.prototype,cd=hJ.prototype.toString,d5=cI.hasOwnProperty,cU=0,gy=cI.toString,fx=n._,dM=dU("^"+cd.call(d5).replace(/[\\^$.*+?()[\]{}|]/g,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$"),bY=g2.ArrayBuffer,hL=g2.clearTimeout,g1=g2.parseFloat,gf=dg.pow,eJ=cI.propertyIsEnumerable,cy=df(g2,"Set"),dy=g2.setTimeout,fL=dp.splice,T=g2.Uint8Array,gN=df(g2,"WeakMap"),l=dg.ceil,fZ=df(ih,"create"),h1=dg.floor,E=df(f6,"isArray"),ev=g2.isFinite,il=df(ih,"keys"),hq=dg.max,fc=dg.min,cK=df(hf,"now"),eX=g2.parseInt,eN=dg.random,fP=gU.NEGATIVE_INFINITY,ez=gU.POSITIVE_INFINITY,hx=4294967295,e1=hx-1,L=hx>>>1,b5=9007199254740991,gk=gN&&new gN,fA={};g8.support={};g8.templateSettings={escape:af,evaluate:bI,interpolate:i,variable:"",imports:{_:g8}};var eb=function(){function m(){}return function(ca){if(fI(ca)){m.prototype=ca;var Q=new m;m.prototype=bd}return Q||{}}}(),dZ=dz(cb),cm=dz(gq,!0),gC=fM(),dC=fM(!0),u=gk?function(m,Q){return gk.set(m,Q),m}:eC,f3=gk?function(m){return gk.get(m)}:gp,g7=hK("length"),at=function(){var m=0,Q=0;return function(ce,ci){var ca=gX(),cn=bf-(ca-Q);if(Q=ca,cn>0){if(++m>=bp){return ce}}else{m=0}return u(ce,ci)}}(),hF=f5(function(m,Q){return au(m)&&dl(m)?cQ(m,e5(Q,!1,!0)):[]}),dd=hs(),gQ=hs(!0),h8=f5(function(di){for(var ce=di.length,m=ce,cu=f6(dn),cn=bT(),ca=cn==aS,de=[];m--;){var da=di[m]=dl(da=di[m])?da:[];cu[m]=ca&&da.length>=120?gO(m&&da):null}var cr=di[0],ci=-1,dn=cr?cr.length:0,Q=cu[0];di:for(;++ci<dn;){if(da=cr[ci],(Q?dk(Q,da):cn(de,da,0))<0){for(var m=ce;--m;){var co=cu[m];if((co?dk(co,da):cn(di[m],da,0))<0){continue di}}Q&&Q.push(da),de.push(da)}}return de}),dQ=f5(function(m,ca){ca=e5(ca);var Q=J(m,ca);return gV(m,ca.sort(aF)),Q}),hQ=d1(),c0=d1(!0),dj=f5(function(m){return cg(e5(m,!1,!0))}),cE=f5(function(m,Q){return dl(m)?cQ(m,Q):[]}),fh=f5(cz),ct=f5(function(m){var ce=m.length,Q=ce>2?m[ce-2]:bd,ca=ce>1?m[ce-1]:bd;return ce>2&&"function"==typeof Q?ce-=2:(Q=ce>1&&"function"==typeof ca?(--ce,ca):bd,ca=bd),m.length=ce,gL(m,Q,ca)}),en=f5(function(m){return m=e5(m),this.thru(function(Q){return fj(hI(Q)?Q:[cL(Q)],m)})}),c8=f5(function(m,Q){return J(m,e5(Q))}),gJ=eK(function(m,ca,Q){d5.call(m,Q)?++m[Q]:m[Q]=1}),fH=g(dZ),dX=g(cm,!0),b8=eY(d9,dZ),hZ=eY(cZ,cm),hk=eK(function(m,ca,Q){d5.call(m,Q)?m[Q].push(ca):m[Q]=[ca]}),gt=eK(function(m,ca,Q){m[Q]=ca}),eT=f5(function(ca,co,ce){var ci=-1,Q="function"==typeof co,cn=cp(co),m=dl(ca)?f6(ca.length):[];return dZ(ca,function(cu){var cr=Q?co:cn&&null!=cu?cu[co]:bd;m[++ci]=cr?cr.apply(cu,ce):c2(cu,co,ce)}),m}),cN=eK(function(m,ca,Q){m[Q?0:1].push(ca)},function(){return[[],[]]}),dI=N(cD,dZ),fV=N(dB,cm),bU=f5(function(m,ca){if(null==m){return[]}var Q=ca[2];return Q&&fk(ca[0],ca[1],Q)&&(ca.length=1),cJ(m,e5(ca),[])}),gX=cK||function(){return(new hf).getTime()},C=f5(function(Q,ci,ca){var ce=bm;if(ca.length){var m=ar(ca,C.placeholder);ce|=bc}return cs(Q,ce,ci,ca,m)}),f9=f5(function(Q,ci){ci=ci.length?e5(ci):c9(Q);for(var ca=-1,ce=ci.length;++ca<ce;){var m=ci[ca];Q[m]=cs(Q[m],bm,Q)}return Q}),ig=f5(function(Q,ci,ca){var ce=bm|ba;if(ca.length){var m=ar(ca,ig.placeholder);ce|=bc}return cs(ci,ce,Q,ca,m)}),O=h3(bs),eF=h3(bi),x=f5(function(m,Q){return fg(m,1,Q)}),hD=f5(function(m,ca,Q){return fg(m,ca,Q)}),fs=cM(),cX=cM(!0),e7=f5(function(m,ca){if(ca=e5(ca),"function"!=typeof m||!b3(ca,aP)){throw new c4(aD)}var Q=ca.length;return f5(function(ci){for(var ce=fc(ci.length,Q);ce--;){ci[ce]=ca[ce](ci[ce])}return m.apply(this,ci)})}),eW=e2(bc),fY=e2(a4),eI=f5(function(m,Q){return cs(m,bv,bd,bd,bd,e5(Q))}),hI=E||function(m){return au(m)&&c6(m.length)&&gy.call(m)==a3},fb=cA(hg),W=cA(function(m,ca,Q){return Q?f2(m,ca,Q):h6(m,ca)}),ch=G(W,gP),gx=G(fb,dW),fK=fd(cb),es=fd(gq),eh=eO(gC),cB=eO(dC),gM=fQ(cb),dL=fQ(gq),H=il?function(m){var Q=null==m?bd:m.constructor;return"function"==typeof Q&&Q.prototype===m||"function"!=typeof m&&dl(m)?gs(m):fI(m)?il(m):[]}:gs,gd=eA(!0),hp=eA(),b1=f5(function(m,ca){if(null==m){return{}}if("function"!=typeof ca[0]){var ca=gj(e5(ca),hW);return b6(m,cQ(cj(m),ca))}var Q=b0(ca[0],ca[1],3);return hY(m,function(ce,cn,ci){return !Q(ce,cn,ci)})}),hU=f5(function(m,Q){return null==m?{}:"function"==typeof Q[0]?hY(m,b0(Q[0],Q[1],3)):b6(m,e5(Q))}),dt=o(function(m,ca,Q){return ca=ca.toLowerCase(),m+(Q?ca.charAt(0).toUpperCase()+ca.slice(1):ca)}),g0=o(function(m,ca,Q){return m+(Q?"-":"")+ca.toLowerCase()}),h=hy(),d2=hy(!0),h4=o(function(m,ca,Q){return m+(Q?"_":"")+ca.toLowerCase()}),dc=o(function(m,ca,Q){return m+(Q?" ":"")+(ca.charAt(0).toUpperCase()+ca.slice(1))}),dx=f5(function(m,ca){try{return m.apply(bd,ca)}catch(Q){return S(Q)?Q:new bV(Q)}}),cS=f5(function(m,Q){return function(ca){return c2(ca,m,Q)}}),fw=f5(function(m,Q){return function(ca){return c2(m,ca,Q)}}),cq=ef("ceil"),em=ef("floor"),c7=ew(fl,fP),gI=ew(dm,ez),fG=ef("round");return g8.prototype=g4.prototype,hj.prototype=eb(g4.prototype),hj.prototype.constructor=hj,hd.prototype=eb(g4.prototype),hd.prototype.constructor=hd,dN.prototype["delete"]=gR,dN.prototype.get=ib,dN.prototype.has=dR,dN.prototype.set=hS,c1.prototype.push=cF,Z.Cache=dN,g8.after=eP,g8.ary=cH,g8.assign=W,g8.at=c8,g8.before=dE,g8.bind=C,g8.bindAll=f9,g8.bindKey=ig,g8.callback=eQ,g8.chain=gc,g8.chunk=bt,g8.compact=gW,g8.constant=fS,g8.countBy=gJ,g8.create=h0,g8.curry=O,g8.curryRight=eF,g8.debounce=fR,g8.defaults=ch,g8.defaultsDeep=gx,g8.defer=x,g8.delay=hD,g8.difference=hF,g8.drop=B,g8.dropRight=f8,g8.dropRightWhile=h9,g8.dropWhile=M,g8.fill=eE,g8.filter=dw,g8.flatten=hC,g8.flattenDeep=fq,g8.flow=fs,g8.flowRight=cX,g8.forEach=b8,g8.forEachRight=hZ,g8.forIn=eh,g8.forInRight=cB,g8.forOwn=gM,g8.forOwnRight=dL,g8.functions=c9,g8.groupBy=hk,g8.indexBy=gt,g8.initial=e6,g8.intersection=h8,g8.invert=ft,g8.invoke=eT,g8.keys=H,g8.keysIn=cj,g8.map=cl,g8.mapKeys=gd,g8.mapValues=hp,g8.matches=hA,g8.matchesProperty=e4,g8.memoize=Z,g8.merge=fb,g8.method=cS,g8.methodOf=fw,g8.mixin=P,g8.modArgs=e7,g8.negate=gT,g8.omit=b1,g8.once=y,g8.pairs=d8,g8.partial=eW,g8.partialRight=fY,g8.partition=cN,g8.pick=hU,g8.pluck=eg,g8.property=fD,g8.propertyOf=ej,g8.pull=eH,g8.pullAt=dQ,g8.range=d3,g8.rearg=eI,g8.reject=c3,g8.remove=hG,g8.rest=e9,g8.restParam=f5,g8.set=gB,g8.shuffle=fC,g8.slice=U,g8.sortBy=hV,g8.sortByAll=bU,g8.sortByOrder=hc,g8.spread=h7,g8.take=cf,g8.takeRight=gw,g8.takeRightWhile=fJ,g8.takeWhile=eq,g8.tap=hm,g8.throttle=K,g8.thru=bZ,g8.times=cv,g8.toArray=ik,g8.toPlainObject=dY,g8.transform=fz,g8.union=dj,g8.uniq=ed,g8.unzip=cz,g8.unzipWith=gL,g8.values=dP,g8.valuesIn=b2,g8.where=gm,g8.without=cE,g8.wrap=eB,g8.xor=dK,g8.zip=fh,g8.zipObject=F,g8.zipWith=ct,g8.backflow=cX,g8.collect=cl,g8.compose=cX,g8.each=b8,g8.eachRight=hZ,g8.extend=W,g8.iteratee=eQ,g8.methods=c9,g8.object=F,g8.select=dw,g8.tail=e9,g8.unique=ed,P(g8,g8),g8.add=dF,g8.attempt=dx,g8.camelCase=dt,g8.capitalize=gh,g8.ceil=cq,g8.clone=p,g8.cloneDeep=hz,g8.deburr=eL,g8.endsWith=cC,g8.escape=dA,g8.escapeRegExp=fN,g8.every=db,g8.find=fH,g8.findIndex=dd,g8.findKey=fK,g8.findLast=dX,g8.findLastIndex=gQ,g8.findLastKey=es,g8.findWhere=cR,g8.first=v,g8.floor=em,g8.get=dv,g8.gt=fl,g8.gte=cT,g8.has=cO,g8.identity=eC,g8.includes=fv,g8.indexOf=cV,g8.inRange=hO,g8.isArguments=e3,g8.isArray=hI,g8.isBoolean=eU,g8.isDate=fW,g8.isElement=eG,g8.isEmpty=hE,g8.isEqual=e8,g8.isError=S,g8.isFinite=cc,g8.isFunction=gv,g8.isMatch=ep,g8.isNaN=d7,g8.isNative=cx,g8.isNull=gK,g8.isNumber=dJ,g8.isObject=fI,g8.isPlainObject=D,g8.isRegExp=gb,g8.isString=hl,g8.isTypedArray=bX,g8.isUndefined=hN,g8.kebabCase=g0,g8.last=eV,g8.lastIndexOf=fX,g8.lt=dm,g8.lte=gY,g8.max=c7,g8.min=gI,g8.noConflict=b9,g8.noop=gp,g8.now=gX,g8.pad=X,g8.padLeft=h,g8.padRight=d2,g8.parseInt=q,g8.random=g5,g8.reduce=dI,g8.reduceRight=fV,g8.repeat=f1,g8.result=cY,g8.round=fG,g8.runInContext=a7,g8.size=dT,g8.snakeCase=h4,g8.some=b4,g8.sortedIndex=hQ,g8.sortedLastIndex=c0,g8.startCase=dc,g8.startsWith=h5,g8.sum=z,g8.template=I,g8.trim=ex,g8.trimLeft=j,g8.trimRight=hv,g8.trunc=ff,g8.unescape=cP,g8.uniqueId=gF,g8.words=eZ,g8.all=db,g8.any=b4,g8.contains=fv,g8.eq=e8,g8.detect=fH,g8.foldl=dI,g8.foldr=fV,g8.head=v,g8.include=fv,g8.inject=dI,P(g8,function(){var m={};return cb(g8,function(Q,ca){g8.prototype[ca]||(m[ca]=Q)}),m}(),!1),g8.sample=gE,g8.prototype.sample=function(m){return this.__chain__||null!=m?this.thru(function(Q){return gE(Q,m)}):gE(this.value())},g8.VERSION=a5,d9(["bind","bindKey","curry","curryRight","partial","partialRight"],function(m){g8[m].placeholder=g8}),d9(["drop","take"],function(m,Q){hd.prototype[m]=function(ca){var ce=this.__filtered__;if(ce&&!Q){return new hd(this)}ca=null==ca?1:hq(h1(ca)||0,0);var ci=this.clone();return ce?ci.__takeCount__=fc(ci.__takeCount__,ca):ci.__views__.push({size:ca,type:m+(ci.__dir__<0?"Right":"")}),ci},hd.prototype[m+"Right"]=function(ca){return this.reverse()[m](ca).reverse()}}),d9(["filter","map","takeWhile"],function(m,ce){var Q=ce+1,ca=Q!=ap;hd.prototype[m]=function(cn,co){var ci=this.clone();return ci.__iteratees__.push({iteratee:f4(cn,co,1),type:Q}),ci.__filtered__=ci.__filtered__||ca,ci}}),d9(["first","last"],function(m,ca){var Q="take"+(ca?"Right":"");hd.prototype[m]=function(){return this[Q](1).value()[0]}}),d9(["initial","rest"],function(m,ca){var Q="drop"+(ca?"":"Right");hd.prototype[m]=function(){return this.__filtered__?new hd(this):this[Q](1)}}),d9(["pluck","where"],function(m,ce){var Q=ce?"filter":"map",ca=ce?A:fD;hd.prototype[m]=function(ci){return this[Q](ca(ci))}}),hd.prototype.compact=function(){return this.filter(eC)},hd.prototype.reject=function(m,Q){return m=f4(m,Q,1),this.filter(function(ca){return !m(ca)})},hd.prototype.slice=function(m,ca){m=null==m?0:+m||0;var Q=this;return Q.__filtered__&&(m>0||ca<0)?new hd(Q):(m<0?Q=Q.takeRight(-m):m&&(Q=Q.drop(m)),ca!==bd&&(ca=+ca||0,Q=ca<0?Q.dropRight(-ca):Q.take(ca-m)),Q)},hd.prototype.takeRightWhile=function(m,Q){return this.reverse().takeWhile(m,Q).reverse()},hd.prototype.toArray=function(){return this.take(ez)},cb(hd.prototype,function(ca,ce){var ci=/^(?:filter|map|reject)|While$/.test(ce),Q=/^(?:first|last)$/.test(ce),m=g8[Q?"take"+("last"==ce?"Right":""):ce];m&&(g8.prototype[ce]=function(){var cr=Q?[1]:arguments,cn=this.__chain__,dn=this.__wrapped__,de=!!this.__actions__.length,cu=dn instanceof hd,ea=cr[0],co=cu||hI(dn);co&&ci&&"function"==typeof ea&&1!=ea.length&&(cu=co=!1);var da=function(ec){return Q&&cn?m(ec,1)[0]:m.apply(bd,eM([ec],cr))},du={func:bZ,args:[da],thisArg:bd},di=cu&&!de;if(Q&&!cn){return di?(dn=dn.clone(),dn.__actions__.push(du),ca.call(dn)):m.call(bd,this.value())[0]}if(!Q&&co){dn=di?dn:new hd(this);var dr=ca.apply(dn,cr);return dr.__actions__.push(du),new hj(dr,cn)}return this.thru(da)})}),d9(["join","pop","push","replace","shift","sort","splice","split","unshift"],function(Q){var ca=(/^(?:replace|split)$/.test(Q)?fm:dp)[Q],ce=/^(?:push|sort|unshift)$/.test(Q)?"tap":"thru",m=/^(?:join|pop|replace|shift)$/.test(Q);g8.prototype[Q]=function(){var ci=arguments;return m&&!this.__chain__?ca.apply(this.value(),ci):this[ce](function(cn){return ca.apply(cn,ci)})}}),cb(hd.prototype,function(Q,ca){var ce=g8[ca];if(ce){var m=ce.name,ci=fA[m]||(fA[m]=[]);ci.push({name:ca,func:ce})}}),fA[b7(bd,ba).name]=[{name:"wrapper",func:bd}],hd.prototype.clone=g9,hd.prototype.reverse=ht,hd.prototype.value=gz,g8.prototype.chain=hR,g8.prototype.commit=ds,g8.prototype.concat=en,g8.prototype.plant=gZ,g8.prototype.reverse=im,g8.prototype.toString=d0,g8.prototype.run=g8.prototype.toJSON=g8.prototype.valueOf=g8.prototype.value=h2,g8.prototype.collect=g8.prototype.map,g8.prototype.head=g8.prototype.first,g8.prototype.select=g8.prototype.filter,g8.prototype.tail=g8.prototype.rest,g8}var bd,a5="3.10.1",bm=1,ba=2,bq=4,bs=8,bi=16,bc=32,a4=64,bG=128,bv=256,bj=30,a1="...",bp=150,bf=16,bl=200,br=1,ap=2,aD="Expected a function",bk="__lodash_placeholder__",bo="[object Arguments]",a3="[object Array]",bn="[object Boolean]",aX="[object Date]",aZ="[object Error]",aW="[object Function]",bb="[object Map]",a6="[object Number]",aY="[object Object]",bL="[object RegExp]",bS="[object Set]",an="[object String]",av="[object WeakMap]",aA="[object ArrayBuffer]",bu="[object Float32Array]",am="[object Float64Array]",bH="[object Int8Array]",bJ="[object Int16Array]",bB="[object Int32Array]",ah="[object Uint8Array]",aU="[object Uint8ClampedArray]",aj="[object Uint16Array]",ae="[object Uint32Array]",bR=/\b__p \+= '';/g,bx=/\b(__p \+=) '' \+/g,bD=/(__e\(.*?\)|\b__t\)) \+\n'';/g,ab=/&(?:amp|lt|gt|quot|#39|#96);/g,bz=/[&<>"'`]/g,bN=RegExp(ab.source),aQ=RegExp(bz.source),af=/<%-([\s\S]+?)%>/g,bI=/<%([\s\S]+?)%>/g,i=/<%=([\s\S]+?)%>/g,bP=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\n\\]|\\.)*?\1)\]/,a9=/^\w*$/,bE=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\n\\]|\\.)*?)\2)\]/g,a0=/^[:!,]|[\\^$.*+?()[\]{}|\/]|(^[0-9a-fA-Fnrtuvx])|([\n\r\u2028\u2029])/g,ac=RegExp(a0.source),ag=/[\u0300-\u036f\ufe20-\ufe23]/g,aV=/\\(\\)?/g,bM=/\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g,aC=/\w*$/,bh=/^0[xX]/,a2=/^\[object .+?Constructor\]$/,by=/^\d+$/,aa=/[\xc0-\xd6\xd8-\xde\xdf-\xf6\xf8-\xff]/g,al=/($^)/,r=/['\n\r\u2028\u2029\\]/g,bC=function(){var g="[A-Z\\xc0-\\xd6\\xd8-\\xde]",h="[a-z\\xdf-\\xf6\\xf8-\\xff]+";return RegExp(g+"+(?="+g+h+")|"+g+"?"+h+"|"+g+"+|[0-9]+","g")}(),aw=["Array","ArrayBuffer","Date","Error","Float32Array","Float64Array","Function","Int8Array","Int16Array","Int32Array","Math","Number","Object","RegExp","Set","String","_","clearTimeout","isFinite","parseFloat","parseInt","setTimeout","TypeError","Uint8Array","Uint8ClampedArray","Uint16Array","Uint32Array","WeakMap"],ao=-1,be={};be[bu]=be[am]=be[bH]=be[bJ]=be[bB]=be[ah]=be[aU]=be[aj]=be[ae]=!0,be[bo]=be[a3]=be[aA]=be[bn]=be[aX]=be[aZ]=be[aW]=be[bb]=be[a6]=be[aY]=be[bL]=be[bS]=be[an]=be[av]=!1;var t={};t[bo]=t[a3]=t[aA]=t[bn]=t[aX]=t[bu]=t[am]=t[bH]=t[bJ]=t[bB]=t[a6]=t[aY]=t[bL]=t[an]=t[ah]=t[aU]=t[aj]=t[ae]=!0,t[aZ]=t[aW]=t[bb]=t[bS]=t[av]=!1;var ai={"À":"A","Á":"A","Â":"A","Ã":"A","Ä":"A","Å":"A","à":"a","á":"a","â":"a","ã":"a","ä":"a","å":"a","Ç":"C","ç":"c","Ð":"D","ð":"d","È":"E","É":"E","Ê":"E","Ë":"E","è":"e","é":"e","ê":"e","ë":"e","Ì":"I","Í":"I","Î":"I","Ï":"I","ì":"i","í":"i","î":"i","ï":"i","Ñ":"N","ñ":"n","Ò":"O","Ó":"O","Ô":"O","Õ":"O","Ö":"O","Ø":"O","ò":"o","ó":"o","ô":"o","õ":"o","ö":"o","ø":"o","Ù":"U","Ú":"U","Û":"U","Ü":"U","ù":"u","ú":"u","û":"u","ü":"u","Ý":"Y","ý":"y","ÿ":"y","Æ":"Ae","æ":"ae","Þ":"Th","þ":"th","ß":"ss"},bK={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","`":"&#96;"},aH={"&amp;":"&","&lt;":"<","&gt;":">","&quot;":'"',"&#39;":"'","&#96;":"`"},bA={"function":!0,object:!0},bQ={0:"x30",1:"x31",2:"x32",3:"x33",4:"x34",5:"x35",6:"x36",7:"x37",8:"x38",9:"x39",A:"x41",B:"x42",C:"x43",D:"x44",E:"x45",F:"x46",a:"x61",b:"x62",c:"x63",d:"x64",e:"x65",f:"x66",n:"x6e",r:"x72",t:"x74",u:"x75",v:"x76",x:"x78"},ad={"\\":"\\","'":"'","\n":"n","\r":"r","\u2028":"u2028","\u2029":"u2029"},bF=bA[typeof d]&&d&&!d.nodeType&&d,ak=bA[typeof f]&&f&&!f.nodeType&&f,bg=bF&&ak&&"object"==typeof e&&e&&e.Object&&e,a8=bA[typeof self]&&self&&self.Object&&self,bO=bA[typeof window]&&window&&window.Object&&window,n=(ak&&ak.exports===bF&&bF,bg||bO!==(this&&this.window)&&bO||a8||this),aB=a7();n._=aB,c=function(){return aB}.call(d,b,d,f),!(c!==bd&&(f.exports=c))}).call(this)}).call(d,b(221)(a),function(){return this}())},110:function(k,y,q){function E(d,l){for(var f=0;f<d.length;f++){var g=d[f],c=m[g.id];if(c){c.refs++;for(var h=0;h<c.parts.length;h++){c.parts[h](g.parts[h])}for(;h<g.parts.length;h++){c.parts.push(H(g.parts[h],l))}}else{for(var a=[],h=0;h<g.parts.length;h++){a.push(H(g.parts[h],l))}m[g.id]={id:g.id,refs:1,parts:a}}}}function A(L){for(var h=[],d={},s=0;s<L.length;s++){var l=L[s],g=l[0],K=l[1],J=l[2],v=l[3],p={css:K,media:J,sourceMap:v};d[g]?d[g].parts.push(p):h.push(d[g]={id:g,parts:[p]})}return h}function x(){var a=document.createElement("style"),c=b();return a.type="text/css",c.appendChild(a),a}function j(){var a=document.createElement("link"),c=b();return a.rel="stylesheet",c.appendChild(a),a}function H(f,l){var g,h,d;if(l.singleton){var c=I++;g=F||(F=x()),h=G.bind(null,g,c,!1),d=G.bind(null,g,c,!0)}else{f.sourceMap&&"function"==typeof URL&&"function"==typeof URL.createObjectURL&&"function"==typeof URL.revokeObjectURL&&"function"==typeof Blob&&"function"==typeof btoa?(g=j(),h=z.bind(null,g),d=function(){g.parentNode.removeChild(g),g.href&&URL.revokeObjectURL(g.href)}):(g=x(),h=D.bind(null,g),d=function(){g.parentNode.removeChild(g)})}return h(f),function(a){if(a){if(a.css===f.css&&a.media===f.media&&a.sourceMap===f.sourceMap){return}h(f=a)}else{d()}}}function G(d,l,f,g){var c=f?"":g.css;if(d.styleSheet){d.styleSheet.cssText=C(l,c)}else{var h=document.createTextNode(c),a=d.childNodes;a[l]&&d.removeChild(a[l]),a.length?d.insertBefore(h,a[l]):d.appendChild(h)}}function D(a,f){var c=f.css,d=f.media;f.sourceMap;if(d&&a.setAttribute("media",d),a.styleSheet){a.styleSheet.cssText=c}else{for(;a.firstChild;){a.removeChild(a.firstChild)}a.appendChild(document.createTextNode(c))}}function z(c,h){var d=h.css,f=(h.media,h.sourceMap);f&&(d+="\n/*# sourceMappingURL=data:application/json;base64,"+btoa(unescape(encodeURIComponent(JSON.stringify(f))))+" */");var a=new Blob([d],{type:"text/css"}),g=c.href;c.href=URL.createObjectURL(a),g&&URL.revokeObjectURL(g)}var m={},w=function(a){var c;return function(){return"undefined"==typeof c&&(c=a.apply(this,arguments)),c}},B=w(function(){return/msie [6-9]\b/.test(window.navigator.userAgent.toLowerCase())}),b=w(function(){return document.head||document.getElementsByTagName("head")[0]}),F=null,I=0;k.exports=function(a,d){d=d||{},"undefined"==typeof d.singleton&&(d.singleton=B());var c=A(a);return E(c,d),function(i){for(var p=[],h=0;h<c.length;h++){var g=c[h],r=m[g.id];r.refs--,p.push(r)}if(i){var n=A(i);E(n,d)}for(var h=0;h<p.length;h++){var r=p[h];if(0===r.refs){for(var e=0;e<r.parts.length;e++){r.parts[e]()}delete m[r.id]}}}};var C=function(){var a=[];return function(d,c){return a[d]=c,a.filter(Boolean).join("\n")}}()},113:function(b,g,c){var d=c(89),a=c(10)("iterator"),f=c(32);b.exports=c(17).getIteratorMethod=function(e){if(void 0!=e){return e[a]||e["@@iterator"]||f[d(e)]}}},114:function(a,d,b){var c=b(166)(!0);b(93)(String,"String",function(e){this._t=String(e),this._i=0},function(){var e,g=this._t,f=this._i;return f>=g.length?{value:void 0,done:!0}:(e=c(g,f),this._i+=e.length,{value:e,done:!1})})},115:function(w,g,b){b(170);for(var m=b(11),j=b(23),d=b(32),v=b(10)("toStringTag"),q=["NodeList","DOMTokenList","MediaList","StyleSheetList","CSSRuleList"],p=0;p<5;p++){var k=q[p],h=m[k],x=h&&h.prototype;x&&!x[v]&&j(x,v,k),d[k]=d.Array}},139:function(A,j,b){function w(a){return a&&a.__esModule?a:{"default":a}}Object.defineProperty(j,"__esModule",{value:!0});var m=b(86),g=w(m),z=b(87),y=w(z),x=b(88),v=w(x),k=b(105),B=w(k),d=B["default"].noConflict(),q=function(){function a(c){(0,y["default"])(this,a),this.args=c,d.bindAll(this,"showError","doWithdraw"),this.init()}return(0,v["default"])(a,[{key:"init",value:function(){var c=this;this.dialog=new AJS.Dialog({width:500,height:180,id:"withdraw-confirm",closeOnOutsideClick:!0}).addHeader("Are you sure to withdraw?").addPanel("WithdrawPanel","\u003cp\u003e\u003cdiv id=\u0022tutorial-withdrawal-error\u0022\u003e\u003c/div\u003eAre you sure you want to withdraw from this tutorial?\u003c/p\u003e","withdraw-panel").addButtonPanel().addSubmit("Withdraw",c.doWithdraw).addCancel("Cancel",function(e){e.hide()})}},{key:"show",value:function(){this.dialog.show()}},{key:"hide",value:function(){this.dialog.hide()}},{key:"spinButton",value:function(c){var e=$(c).find(".spin");e.length<=0&&($(c).prepend('<span class="aui-icon aui-icon-small spin"></span>&nbsp;'),e=$(c).find(".spin")),$(c).attr("aria-disabled",!0).attr("disabled",!0),e.css({display:"inline-block"}),e.spin()}},{key:"unSpinButton",value:function(c){var e=$(c).find(".spin");$(c).attr("aria-disabled",!1).attr("disabled",!1),e.spinStop(),e.hide()}},{key:"doWithdraw",value:function(){var c=this;this.spinButton(".button-panel-submit-button"),this.withdrawTutorial(this.args.tutorial.id).then(function(){c.args.withdrawSuccess()})["catch"](function(e){c.unSpinButton(".button-panel-submit-button"),c.showError(e)})}},{key:"showError",value:function(c){var e=0===c.status?"Not connected. Please verify your network connection.":c.statusText+" ("+c.status+").";AJS.messages.error("#tutorial-withdrawal-error",{title:AJS.format("Could not withdraw from \u0027\u0027{0}\u0027\u0027 because the following error(s) occurred:",this.args.tutorial.name),body:"<p>"+e+"</p>"}),this.dialog.updateHeight()}},{key:"withdrawTutorial",value:function(c){var e=this;return new g["default"](function(f,h){$.ajax({url:AJS.Meta.get("base-url")+"/rest/composition/1.0/tutorial/withdraw/"+c,type:"PUT",contentType:"application/json",cache:!1,context:e,success:function(i){f(i)},error:function(i){h(i)}})})}}]),a}();j["default"]=q},140:function(a,c,b){a.exports={"default":b(142),__esModule:!0}},142:function(a,d,b){b(171);var c=b(17).Object;a.exports=function(e,g,f){return c.defineProperty(e,g,f)}},143:function(a,c,b){b(172),b(114),b(115),b(173),a.exports=b(17).Promise},144:function(a,b){a.exports=function(){}},145:function(a,b){a.exports=function(c,g,d,f){if(!(c instanceof g)||void 0!==f&&f in c){throw TypeError(d+": incorrect invocation!")}return c}},146:function(b,g,c){var d=c(66),a=c(98),f=c(167);b.exports=function(e){return function(p,k,j){var i,o=d(p),m=a(o.length),h=f(j,m);if(e&&k!=k){for(;m>h;){if(i=o[h++],i!=i){return !0}}}else{for(;m>h;h++){if((e||h in o)&&o[h]===k){return e||h||0}}}return !e&&-1}}},147:function(v,g,b){var m=b(45),j=b(152),d=b(151),s=b(19),q=b(98),p=b(113),k={},h={},g=v.exports=function(A,e,a,B,c){var f,z,l,x,i=c?function(){return A}:p(A),o=m(a,B,e?2:1),u=0;if("function"!=typeof i){throw TypeError(A+" is not iterable!")}if(d(i)){for(f=q(A.length);f>u;u++){if(x=e?o(s(z=A[u])[0],z[1]):o(A[u]),x===k||x===h){return x}}}else{for(l=i.call(A);!(z=l.next()).done;){if(x=j(l,o,z.value,e),x===k||x===h){return x}}}};g.BREAK=k,g.RETURN=h},148:function(a,c,b){a.exports=!b(22)&&!b(91)(function(){return 7!=Object.defineProperty(b(61)("div"),"a",{get:function(){return 7}}).a})},149:function(a,b){a.exports=function(c,g,d){var f=void 0===d;switch(g.length){case 0:return f?c():c.call(d);case 1:return f?c(g[0]):c.call(d,g[0]);case 2:return f?c(g[0],g[1]):c.call(d,g[0],g[1]);case 3:return f?c(g[0],g[1],g[2]):c.call(d,g[0],g[1],g[2]);case 4:return f?c(g[0],g[1],g[2],g[3]):c.call(d,g[0],g[1],g[2],g[3])}return c.apply(d,g)}},150:function(a,d,b){var c=b(44);a.exports=Object("z").propertyIsEnumerable(0)?Object:function(e){return"String"==c(e)?e.split(""):Object(e)}},151:function(b,g,c){var d=c(32),a=c(10)("iterator"),f=Array.prototype;b.exports=function(e){return void 0!==e&&(d.Array===e||f[a]===e)}},152:function(a,d,b){var c=b(19);a.exports=function(g,k,h,f){try{return f?k(c(h)[0],h[1]):k(h)}catch(j){var e=g["return"];throw void 0!==e&&c(e.call(g)),j}}},153:function(c,h,d){var f=d(157),b=d(95),g=d(63),a={};d(23)(a,d(10)("iterator"),function(){return this}),c.exports=function(e,j,i){e.prototype=f(a,{next:b(1,i)}),g(e,j+" Iterator")}},154:function(c,h,d){var f=d(10)("iterator"),b=!1;try{var g=[7][f]();g["return"]=function(){b=!0},Array.from(g,function(){throw 2})}catch(a){}c.exports=function(j,m){if(!m&&!b){return !1}var k=!1;try{var l=[7],i=l[f]();i.next=function(){return{done:k=!0}},l[f]=function(){return i},j(l)}catch(e){}return k}},155:function(a,b){a.exports=function(c,d){return{value:d,done:!!c}}},156:function(m,f,b){var h=b(11),g=b(97).set,d=h.MutationObserver||h.WebKitMutationObserver,l=h.process,k=h.Promise,j="process"==b(44)(l);m.exports=function(){var c,u,i,o=function(){var p,n;for(j&&(p=l.domain)&&p.exit();c;){n=c.fn,c=c.next;try{n()}catch(r){throw c?i():u=void 0,r}}u=void 0,p&&p.enter()};if(j){i=function(){l.nextTick(o)}}else{if(d){var a=!0,e=document.createTextNode("");new d(o).observe(e,{characterData:!0}),i=function(){e.data=a=!a}}else{if(k&&k.resolve){var q=k.resolve();i=function(){q.then(o)}}else{i=function(){g.call(h,o)}}}}return function(p){var n={fn:p,next:void 0};u&&(u.next=n),c||(c=n,i()),u=n}}},157:function(q,g,b){var k=b(19),h=b(158),d=b(90),p=b(64)("IE_PROTO"),m=function(){},l="prototype",j=function(){var f,r=b(61)("iframe"),o=d.length,c="<",a=">";for(r.style.display="none",b(92).appendChild(r),r.src="javascript:",f=r.contentWindow.document,f.open(),f.write(c+"script"+a+"document.F=Object"+c+"/script"+a),f.close(),j=f.F;o--;){delete j[l][d[o]]}return j()};q.exports=Object.create||function(a,e){var c;return null!==a?(m[l]=k(a),c=new m,m[l]=null,c[p]=a):c=j(),void 0===e?c:h(c,e)}},158:function(b,g,c){var d=c(33),a=c(19),f=c(161);b.exports=c(22)?Object.defineProperties:function(i,l){a(i);for(var j,h=f(l),e=h.length,k=0;e>k;){d.f(i,j=h[k++],l[j])}return i}},159:function(c,h,d){var f=d(46),b=d(168),g=d(64)("IE_PROTO"),a=Object.prototype;c.exports=Object.getPrototypeOf||function(e){return e=b(e),f(e,g)?e[g]:"function"==typeof e.constructor&&e instanceof e.constructor?e.constructor.prototype:e instanceof Object?a:null}},160:function(c,h,d){var f=d(46),b=d(66),g=d(146)(!1),a=d(64)("IE_PROTO");c.exports=function(i,m){var j,e=b(i),l=0,k=[];for(j in e){j!=a&&f(e,j)&&k.push(j)}for(;m.length>l;){f(e,j=m[l++])&&(~g(k,j)||k.push(j))}return k}},161:function(b,f,c){var d=c(160),a=c(90);b.exports=Object.keys||function(e){return d(e,a)}},162:function(a,d,b){var c=b(23);a.exports=function(f,h,g){for(var e in h){g&&f[e]?f[e]=h[e]:c(f,e,h[e])}return f}},163:function(a,c,b){a.exports=b(23)},164:function(f,k,g){var h=g(11),d=g(17),j=g(33),c=g(22),b=g(10)("species");f.exports=function(a){var e="function"==typeof d[a]?d[a]:h[a];c&&e&&!e[b]&&j.f(e,b,{configurable:!0,get:function(){return this}})}},165:function(b,g,c){var d=c(19),a=c(59),f=c(10)("species");b.exports=function(h,j){var i,e=d(h).constructor;return void 0===e||void 0==(i=d(e)[f])?j:a(i)}},166:function(b,f,c){var d=c(65),a=c(60);b.exports=function(e){return function(m,i){var k,h,g=String(a(m)),l=d(i),j=g.length;return l<0||l>=j?e?"":void 0:(k=g.charCodeAt(l),k<55296||k>56319||l+1===j||(h=g.charCodeAt(l+1))<56320||h>57343?e?g.charAt(l):k:e?g.slice(l,l+2):(k-55296<<10)+(h-56320)+65536)}}},167:function(b,g,c){var d=c(65),a=Math.max,f=Math.min;b.exports=function(e,h){return e=d(e),e<0?a(e+h,0):f(e,h)}},168:function(a,d,b){var c=b(60);a.exports=function(e){return Object(c(e))}},169:function(a,d,b){var c=b(47);a.exports=function(f,h){if(!c(f)){return f}var g,e;if(h&&"function"==typeof(g=f.toString)&&!c(e=g.call(f))){return e}if("function"==typeof(g=f.valueOf)&&!c(e=g.call(f))){return e}if(!h&&"function"==typeof(g=f.toString)&&!c(e=g.call(f))){return e}throw TypeError("Can't convert object to primitive value")}},170:function(c,h,d){var f=d(144),b=d(155),g=d(32),a=d(66);c.exports=d(93)(Array,"Array",function(e,i){this._t=a(e),this._i=0,this._k=i},function(){var e=this._t,j=this._k,i=this._i++;return !e||i>=e.length?(this._t=void 0,b(1)):"keys"==j?b(0,i):"values"==j?b(0,e[i]):b(0,[i,e[i]])},"values"),g.Arguments=g.Array,f("keys"),f("values"),f("entries")},171:function(a,d,b){var c=b(62);c(c.S+c.F*!b(22),"Object",{defineProperty:b(33).f})},172:function(a,b){},173:function(Z,ae,ab){var an,aj,ad,Y=ab(94),ar=ab(11),ap=ab(45),am=ab(89),ag=ab(62),aa=ab(47),ac=ab(59),ak=ab(145),X=ab(147),ao=ab(165),at=ab(97).set,al=ab(156)(),Q="Promise",W=ar.TypeError,af=ar.process,V=ar[Q],af=ar.process,aq="process"==am(af),ai=function(){},N=!!function(){try{var a=V.resolve(1),c=(a.constructor={})[ab(10)("species")]=function(d){d(ai,ai)};return(aq||"function"==typeof PromiseRejectionEvent)&&a.then(ai) instanceof c}catch(b){}}(),ah=function(a,b){return a===b||a===V&&b===ad},B=function(a){var b;return !(!aa(a)||"function"!=typeof(b=a.then))&&b},G=function(a){return ah(V,a)?new z(a):new aj(a)},z=aj=function(a){var c,b;this.promise=new a(function(d,f){if(void 0!==c||void 0!==b){throw W("Bad Promise constructor")}c=d,b=f}),this.resolve=ac(c),this.reject=ac(b)},J=function(a){try{a()}catch(b){return{error:b}}},D=function(a,c){if(!a._n){a._n=!0;var b=a._c;al(function(){for(var g=a._v,f=1==a._s,h=0,d=function(t){var k,p,j=f?t.ok:t.fail,i=t.resolve,s=t.reject,m=t.domain;try{j?(f||(2==a._h&&H(a),a._h=1),j===!0?k=g:(m&&m.enter(),k=j(g),m&&m.exit()),k===t.promise?s(W("Promise-chain cycle")):(p=B(k))?p.call(k,i,s):i(k)):s(g)}catch(e){s(e)}};b.length>h;){d(b[h++])}a._c=[],a._n=!1,c&&!a._h&&K(a)})}},K=function(a){at.call(ar,function(){var f,c,d,b=a._v;if(L(a)&&(f=J(function(){aq?af.emit("unhandledRejection",b,a):(c=ar.onunhandledrejection)?c({promise:a,reason:b}):(d=ar.console)&&d.error&&d.error("Unhandled promise rejection",b)}),a._h=aq||L(a)?2:1),a._a=void 0,f){throw f.error}})},L=function(a){if(1==a._h){return !1}for(var d,b=a._a||a._c,c=0;b.length>c;){if(d=b[c++],d.fail||!L(d.promise)){return !1}}return !0},H=function(a){at.call(ar,function(){var b;aq?af.emit("rejectionHandled",a):(b=ar.onrejectionhandled)&&b({promise:a,reason:a._v})})},F=function(a){var b=this;b._d||(b._d=!0,b=b._w||b,b._v=a,b._s=2,b._a||(b._a=b._c.slice()),D(b,!0))},q=function(a){var d,b=this;if(!b._d){b._d=!0,b=b._w||b;try{if(b===a){throw W("Promise can't be resolved itself")}(d=B(a))?al(function(){var g={_w:b,_d:!1};try{d.call(a,ap(q,g,1),ap(F,g,1))}catch(f){F.call(g,f)}}):(b._v=a,b._s=1,D(b,!1))}catch(c){F.call({_w:b,_d:!1},c)}}};N||(V=function(a){ak(this,V,Q,"_h"),ac(a),an.call(this);try{a(ap(q,this,1),ap(F,this,1))}catch(b){F.call(this,b)}},an=function(a){this._c=[],this._a=void 0,this._s=0,this._d=!1,this._v=void 0,this._h=0,this._n=!1},an.prototype=ab(162)(V.prototype,{then:function(a,c){var b=G(ao(this,V));return b.ok="function"!=typeof a||a,b.fail="function"==typeof c&&c,b.domain=aq?af.domain:void 0,this._c.push(b),this._a&&this._a.push(b),this._s&&D(this,!1),b.promise},"catch":function(a){return this.then(void 0,a)}}),z=function(){var a=new an;this.promise=a,this.resolve=ap(q,a,1),this.reject=ap(F,a,1)}),ag(ag.G+ag.W+ag.F*!N,{Promise:V}),ab(63)(V,Q),ab(164)(Q),ad=ab(17)[Q],ag(ag.S+ag.F*!N,Q,{reject:function(a){var c=G(this),b=c.reject;return b(a),c.promise}}),ag(ag.S+ag.F*(Y||!N),Q,{resolve:function(a){if(a instanceof V&&ah(a.constructor,this)){return a}var c=G(this),b=c.resolve;return b(a),c.promise}}),ag(ag.S+ag.F*!(N&&ab(154)(function(a){V.all(a)["catch"](ai)})),Q,{all:function(b){var g=this,c=G(g),d=c.resolve,a=c.reject,f=J(function(){var h=[],i=0,e=1;X(b,!1,function(k){var j=i++,l=!1;h.push(void 0),e++,g.resolve(k).then(function(m){l||(l=!0,h[j]=m,--e||d(h))},a)}),--e||d(h)});return f&&a(f.error),c.promise},race:function(b){var f=this,c=G(f),d=c.reject,a=J(function(){X(b,!1,function(e){f.resolve(e).then(c.resolve,d)})});return a&&d(a.error),c.promise}})},221:function(a,b){a.exports=function(c){return c.webpackPolyfill||(c.deprecate=function(){},c.paths=[],c.children=[],c.webpackPolyfill=1),c}},328:function(k,y,q){function E(a){return a&&a.__esModule?a:{"default":a}}Object.defineProperty(y,"__esModule",{value:!0});var A=q(330),x=E(A),j=q(86),H=E(j),G=q(87),D=E(G),z=q(88),m=E(z),w=q(105),B=E(w);q(611);var b=q(139),F=E(b),I=B["default"].noConflict(),C=function(){function a(c){(0,D["default"])(this,a),this.args=c,I.bindAll(this,"onWithdrawButtonClicked"),this.init()}return(0,m["default"])(a,[{key:"init",value:function(){var d=this,h=this.args.ids,f=h.compositionTutorialStepsButton,g=h.withdrawButtonSelector,c=$(f);null!=c&&c.length>0&&(this.showButtonSpinner(c),this.getTutorial(AJS.params.pageId).then(function(e){d.constructStepsDD(c,e),$(g).click(d.onWithdrawButtonClicked),d.tutorialWithdrawal=new F["default"]({tutorial:e.tutorial,withdrawSuccess:function(){location.reload()}})})["catch"](function(){d.constructErrorButton(c)}))}},{key:"onWithdrawButtonClicked",value:function(c){c.preventDefault(),this.tutorialWithdrawal.show()}},{key:"showButtonSpinner",value:function(c){var d=this.args.ids.buttonSpinner;c.removeClass("composition-tutorial-button-placeholder"),c.empty(),c.append('<span class="button-spinner"></span>'),$(d).spin()}},{key:"getTutorial",value:function(c){return new H["default"](function(e,d){$.ajax({type:"GET",url:AJS.Meta.get("base-url")+"/rest/composition/1.0/tutorial/by/page/"+c,dataType:"json",success:function(f){e(f)},error:function(f){d(f)}})})}},{key:"constructErrorButton",value:function(c){c.empty(),c.text(AJS.params.pageTitle),c.attr("aria-owns","tutorial-steps-dd"),c.attr("aria-haspopup","true"),c.attr("href","#tutorial-steps-dd-trigger"),c.addClass("aui-dropdown2-trigger");var e=$('<div id="tutorial-steps-dd" class="aui-style-default aui-dropdown2"></div>'),d=$('<div class="aui-dropdown2-section">\n                <ul>\n                    <li><a><span class="aui-icon aui-icon-small aui-iconfont-warning"></span> Failed to load tutorial</a></li>\n                </ul>\n            </div>');e.append(d),e.insertAfter(c)}},{key:"constructStepsDD",value:function(c,e){var d=$('<div id="tutorial-steps-dd" class="aui-style-default aui-dropdown2"></div>');d.append(this.constructTutorialLink(e)),d.append(this.constructSteps(e)),d.append(this.constructWithdrawTutorial(e)),c.empty(),c.html('<span class="aui-icon aui-icon-small aui-iconfont-approve"></span>'+this.getActiveStep(e)),c.attr("aria-owns","tutorial-steps-dd"),c.attr("aria-haspopup","true"),c.attr("href","#tutorial-steps-dd-trigger"),c.addClass("aui-dropdown2-trigger aui-button"),d.insertAfter(c)}},{key:"getActiveStep",value:function(c){var d=B["default"].find(c.tutorial.steps,function(e){return e.pageId==AJS.params.pageId});return d.step+" - "+d.pageTitle}},{key:"constructSteps",value:function(O){var h='<span class="aui-icon aui-icon-small aui-iconfont-approve green"></span>',d='<span class="aui-icon"></span>',K=$('<ul class="steps"></ul>'),v=h,N=!0,M=!1,L=void 0;try{for(var J,o=(0,x["default"])(O.tutorial.steps);!(N=(J=o.next()).done);N=!0){var P=J.value;K.append('<li><a class="aui-icon-container" href="'+P.pageURL+'">'+v+" "+P.step+" - "+P.pageTitle+"</a></li>"),P.pageId==AJS.params.pageId&&(v=d)}}catch(g){M=!0,L=g}finally{try{!N&&o["return"]&&o["return"]()}finally{if(M){throw L}}}return $('<div class="aui-dropdown2-section"></div>').append('<div class="aui-dropdown2-heading"><strong>Steps</strong></div>').append(K)}},{key:"constructTutorialLink",value:function(c){return $('<div class="aui-dropdown2-section">\n            <ul>\n                <li><a class="aui-icon-container" href="'+AJS.Meta.get("base-url")+"/plugins/composition/tutorial/tutorial.action?key="+c.tutorial.spaceKey+"&tutorialId="+c.tutorial.id+'"><span class="aui-icon aui-icon-small aui-iconfont-doc"></span> '+c.tutorial.name+"</a></li>\n            </ul>\n        </div>")}},{key:"constructWithdrawTutorial",value:function(c){return $('<div class="aui-dropdown2-section">\n            <ul>\n                <li><a id="withdraw-button" class="aui-icon-container" href="#" data-tutorial-id="'+c.tutorial.id+'"><span class="aui-icon aui-icon-small aui-iconfont-remove-label red"></span> '+"Withdraw from Tutorial"+"</a></li>\n            </ul>\n        </div>")}}]),a}();y["default"]=C},330:function(a,c,b){a.exports={"default":b(333),__esModule:!0}},333:function(a,c,b){b(115),b(114),a.exports=b(335)},335:function(b,f,c){var d=c(19),a=c(113);b.exports=c(17).getIterator=function(e){var g=a(e);if("function"!=typeof g){throw TypeError(e+" is not iterable!")}return d(g.call(e))}},517:function(a,c,b){c=a.exports=b(103)(),c.push([a.id,".composition-tutorial-button-placeholder{visibility:hidden}.green{color:green}.red{color:red}#composition-tutorial-steps-link span{padding-left:0}#composition-tutorial-steps-link span.aui-iconfont-approve{padding-right:5px;display:inline-block;color:green}",""])},611:function(a,d,b){var c=b(517);"string"==typeof c&&(c=[[a.id,c,""]]);b(110)(c,{});c.locals&&(a.exports=c.locals)}});
}catch(e){WRMCB(e)};
;
try {
...
Confluence.Templates.Comments.userLogo = function(opt_data, opt_ignored) {
  return '<p class="comment-user-logo">' + ((opt_data.userInfo.userName == null) ? '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/confluence/s/en_GB/6441/ceb41ce4dba5df18f2191c32f0465b43365a715a/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml("User icon") + ': ' + soy.$$escapeHtml("Anonymous") + '" title="' + soy.$$escapeHtml("Anonymous") + '">' : (opt_data.userInfo.profilePicture.isDefault) ? '<a class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" href="' + soy.$$escapeHtml("/confluence") + '/users/profile/editmyprofilepicture.action" title="' + soy.$$escapeHtml("Add a picture of yourself") + '"><img class="userLogo logo defaultLogo" src="' + soy.$$escapeHtml("/confluence/s/en_GB/6441/ceb41ce4dba5df18f2191c32f0465b43365a715a/_") + '/images/icons/profilepics/add_profile_pic.png" alt="' + soy.$$escapeHtml("User icon") + ': ' + soy.$$escapeHtml("Add a picture of yourself") + '"></a>' : '<a class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" href="' + Confluence.Templates.User.userLinkUrl({username: opt_data.userInfo.userName}) + '"><img class="userLogo logo" src="' + soy.$$escapeHtml(opt_data.userInfo.profilePicture.path) + '" alt="' + soy.$$escapeHtml("User icon") + ': ' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" title="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '"></a>') + '</p>';
};
if (goog.DEBUG) {
